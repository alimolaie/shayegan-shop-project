				...
				<div class="col-md-12">
					<div class="content-indent">
						<div class="tt-filters-options desctop-no-sidebar">
							<h1 class="tt-title">
								@if(app()->getLocale()=="en") {{strtoupper($sectionDetails->title_en)}} @else {{$sectionDetails->title_ar}} @endif <span class="tt-title-total">({{count($productLists)}})</span>
							</h1>
                        ...
                        <span id="responseMsg-{{$productList->id}}"></span> 
							...
							<div class="tt-product-inside-hover">
								...
								<div class="tt-row-btn">
									...
									<a href="javascript:;" class="tt-btn-addtocart thumbprod-button-bg addtocartsingle" id="{{$productList->id}}">{{__('webMessage.preorder')}}</a>
                                    @else
                                    <a href="javascript:;" class="tt-btn-addtocart thumbprod-button-bg addtocartsingle" id="{{$productList->id}}">{{__('webMessage.addtocart_btn')}}</a>
                                    @endif
                                    @endif
									@endif
								</div>
