...
@if($settingInfo->theme==1 || $settingInfo->theme==4 || $settingInfo->theme==5 || $settingInfo->theme==6 || $settingInfo->theme==7) 
				...
				<div class="row">
				 <div class="col-lg-8">
				    <div class="form-group">
					    <input type="text" name="trackorderid"  class="form-control" id="trackorderid" placeholder="{{__('webMessage.enter_order_id')}}" autcomplete="off">
                                    
				     </div>
				 </div>
				 <div class="col-lg-2">
				 <input type="button" value="{{__('webMessage.checknow')}}" class="btn btn-border TrackMyOrders">
				 </div>
				</div>
