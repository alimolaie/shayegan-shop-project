		...
		<div class="container container-fluid-custom-mobile-padding">
			<div class="row">
				...
				<div class="col-md-12">
                    ...
                    <option value="popular" @if(Cookie::get('offer_sort_by')=="popular") selected @endif>{{__('webMessage.mostpopular')}}</option>
					<option value="max-price" @if(Cookie::get('offer_sort_by')=="max-price") selected @endif>{{__('webMessage.max_price')}}</option>
					<option value="min-price" @if(Cookie::get('offer_sort_by')=="min-price") selected @endif>{{__('webMessage.min_price')}}</option>
					<option value="a-z" @if(Cookie::get('offer_sort_by')=="a-z") selected @endif>{{__('webMessage.atoz')}}</option>
                    <option value="z-a" @if(Cookie::get('offer_sort_by')=="z-a") selected @endif>{{__('webMessage.ztoa')}}</option>
					</select>
					<select name="offer_per_page" id="offer_per_page">
					<option value="12" @if(Cookie::get('offer_per_page')=="12") selected @endif>{{__('webMessage.show')}}</option>
					<option value="24" @if(Cookie::get('offer_per_page')=="24") selected @endif>24</option>
					<option value="48" @if(Cookie::get('offer_per_page')=="48") selected @endif>48</option>
					<option value="96" @if(Cookie::get('offer_per_page')=="96") selected @endif>96</option>
					</select>
							</div>
