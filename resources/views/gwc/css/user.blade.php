<!--begin::Fonts -->
		...
		<link href="{!! url('admin_assets/assets/plugins/custom/datatables/datatables.bundle.css') !!}" rel="stylesheet" type="text/css" />
		...
		<link href="{!! url('admin_assets/assets/css/pages/wizard/wizard-4.css') !!}" rel="stylesheet" type="text/css" />
		...
		<link href="{!! url('admin_assets/assets/css/skins/brand/dark.css') !!}" rel="stylesheet" type="text/css" />
