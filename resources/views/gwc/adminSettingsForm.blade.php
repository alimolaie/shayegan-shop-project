										...
										<!--begin::Form-->
                                            ...
                                            <div class="form-group "><h5>{{__('adminMessage.websitesetting')}}</h5></div>
                                              ...
                                              <div class="form-group">
												...
												<input type="text" class="form-control @if($errors->has('android_url')) is-invalid @endif" name="android_url" value="@if($settingDetails->android_new_version){{$settingDetails->android_url}}@endif" placeholder="Enter Android App Url">
