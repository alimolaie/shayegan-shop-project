                         ...
                         <div class="kt-portlet__head">
									<div class="kt-portlet__head-toolbar">
										<ul class="nav nav-tabs nav-tabs-space-xl nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-brand" role="tablist">
											...
											@endif
                                            @if(auth()->guard('admin')->user()->can('user-shopdetails'))
											<li class="nav-item">
												<a class="nav-link @if(Request::segment(3)=='shopedit') active @endif"  href="{{url('gwc/users/shopedit/'.request()->id)}}" role="tab">
													<i class="flaticon-home"></i> {{__('adminMessage.shopdetails')}}
												</a>
											</li>
											@endif
										</ul>
                        ...
                        @endif
                         ...
                         <form name="tFrmpass" id="tFrmpass"  method="post"
                          ...
                          <input type="hidden" name="id" value="{{$userDetails->id}}" >
                                           ...
                                           @if(auth()->guard('admin')->user()->can('user-shopdetails'))		
                         <div class="tab-pane @if(Request::segment(3)=='shopedit') active @endif" id="kt_user_edit_tab_3" role="tabpanel">
                         <div class="kt-form kt-form--label-right">
                         <form name="tFrmpass" id="tFrmpass"  method="post"
                          class="uk-form-stacked" enctype="multipart/form-data" action="{{route('adminChangeShop')}}">
                          <input type="hidden" name="_token" value="{{ csrf_token() }}">
                          <input type="hidden" name="id" value="{{$userDetails->id}}" >
													<div class="kt-form__body">
														<div class="kt-section kt-section--first">
															<div class="kt-section__body">
																...
																<div class="form-group row">
																	<label class="col-xl-3 col-lg-3 col-form-label">{{__('adminMessage.shopname')}}</label>
																	<div class="col-lg-4 col-xl-4">
																		<input type="text" name="shop_name_en" class="form-control @if($errors->has('shop_name_en')) is-invalid @endif" value="@if(!empty($userDetails->shop_name_en)){{$userDetails->shop_name_en}}@else{{old('shop_name_en')}}@endif" placeholder="{{__('adminMessage.enter_shop_name_en')}}">                                                                    @if($errors->has('shop_name_en'))
                                                                     <div class="invalid-feedback">{{ $errors->first('shop_name_en') }}</div>
                                                                    @endif
																	</div>
                                                                    <div class="col-lg-5 col-xl-5">
																		<input type="text" name="shop_name_ar" class="form-control @if($errors->has('shop_name_ar')) is-invalid @endif" value="@if(!empty($userDetails->shop_name_ar)){{$userDetails->shop_name_ar}}@else{{old('shop_name_ar')}}@endif" placeholder="{{__('adminMessage.enter_shop_name_ar')}}">                                                               @if($errors->has('shop_name_ar'))
                                                               <div class="invalid-feedback">{{ $errors->first('shop_name_ar') }}</div>
                                                               @endif
																	</div>
																</div>
                                                                
                                                                <div class="form-group row">
																	<label class="col-xl-3 col-lg-3 col-form-label">{{__('adminMessage.contacts')}}</label>
																	<div class="col-lg-4 col-xl-4">
																		<input type="text" name="shop_contact" class="form-control @if($errors->has('shop_contact')) is-invalid @endif" value="@if(!empty($userDetails->shop_contact)){{$userDetails->shop_contact}}@else{{old('shop_contact')}}@endif" placeholder="{{__('adminMessage.enter_shop_contact')}}">                                                                    @if($errors->has('shop_contact'))
                                                                     <div class="invalid-feedback">{{ $errors->first('shop_contact') }}</div>
                                                                    @endif
																	</div>
                                                                    <div class="col-lg-5 col-xl-5">
																		<input type="text" name="shop_email" class="form-control @if($errors->has('shop_email')) is-invalid @endif" value="@if(!empty($userDetails->shop_email)){{$userDetails->shop_email}}@else{{old('shop_email')}}@endif" placeholder="{{__('adminMessage.enter_shop_email')}}">                     @if($errors->has('shop_email'))
                                                               <div class="invalid-feedback">{{ $errors->first('shop_email') }}</div>
                                                               @endif
																	</div>
																</div>
                                                                ...
                                                                <div class="form-group row">
																	<label class="col-xl-3 col-lg-3 col-form-label">{{__('adminMessage.address')}}</label>
																	<div class="col-lg-4 col-xl-4">
																		<textarea type="text" name="shop_address_en" class="form-control @if($errors->has('shop_address_en')) is-invalid @endif" placeholder="{{__('adminMessage.enter_shop_address_en')}}">@if(!empty($userDetails->shop_address_en)){{$userDetails->shop_address_en}}@else{{old('shop_address_en')}}@endif</textarea>                                                                    
                                                                    @if($errors->has('shop_address_en'))
                                                                     <div class="invalid-feedback">{{ $errors->first('shop_address_en') }}</div>
                                                                    @endif
																	</div>
                                                                    <div class="col-lg-5 col-xl-5">
																		<textarea type="text" name="shop_address_ar" class="form-control @if($errors->has('shop_address_ar')) is-invalid @endif"  placeholder="{{__('adminMessage.enter_shop_address_ar')}}">@if(!empty($userDetails->shop_address_ar)){{$userDetails->shop_address_ar}}@else{{old('shop_address_ar')}}@endif</textarea>                                                               
                                                               @if($errors->has('shop_address_ar'))
                                                               <div class="invalid-feedback">{{ $errors->first('shop_address_ar') }}</div>
                                                               @endif
																	</div>
																</div>
                                                                ...
                                                                <div class="form-group row">
																	<label class="col-xl-3 col-lg-3 col-form-label">{{__('adminMessage.commission')}}(%)</label>
																	<div class="col-lg-2 col-xl-2">
																		<input type="text" name="shop_commission" class="form-control @if($errors->has('shop_commission')) is-invalid @endif" value="@if(!empty($userDetails->shop_commission)){{$userDetails->shop_commission}}@else{{old('shop_commission')}}@endif" placeholder="{{__('adminMessage.enter_shop_commission')}}">         @if($errors->has('shop_commission'))
                                                                     <div class="invalid-feedback">{{ $errors->first('shop_commission') }}</div>
                                                                    @endif
																	</div>
