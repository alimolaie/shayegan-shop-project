                         ...
                         <form name="tFrm"  id="form_validation"  method="post"
                          ...
                          <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                           ...
                                           <div class="form-group row">
                                                ...
                                                <input required type="text" class="form-control @if($errors->has('item_code')) is-invalid @endif" name="item_code"
                                                ...
                                                <input type="text" class="form-control @if($errors->has('weight')) is-invalid @endif" name="weight"
                                                               value="{{old('weight')}}" autocomplete="off" placeholder="{{__('adminMessage.enter_weight')}}" />
