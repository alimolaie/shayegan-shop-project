                    ...
                    <div class="kt-container  kt-container--fluid ">
                        <div class="kt-subheader__main">
                            ...
                            <div class="kt-subheader__breadcrumbs">
                                ...
                                <a href="javascript:;" class="kt-subheader__breadcrumbs-link">{{__('adminMessage.createcurrency')}}</a>
                            </div>
                        </div>
                    ...
                    <div class="kt-portlet">
                        ...
                        @if(auth()->guard('admin')->user()->can('currency-create'))
                            ...
                            <form name="tFrm"  id="form_validation"  method="post"
                                  class="kt-form" enctype="multipart/form-data" action="{{route('currency.store')}}">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-4">
                                            ...
                                            <input type="text" class="form-control @if($errors->has('currency_code')) is-invalid @endif" name="currency_code"
                                                   value="{{old('currency_code')}}" autocomplete="off" placeholder="{{__('adminMessage.enter_currency_code')}}" />
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <input type="text" class="form-control @if($errors->has('exchange_rate')) is-invalid @endif" name="exchange_rate"
                                                   value="{{old('exchange_rate')}}" autocomplete="off" placeholder="{{__('adminMessage.enter_exchange_rate')}}" />
