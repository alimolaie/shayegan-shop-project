			...
			<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
				...
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
                    ...
                    <form name="tFrm"  id="form_validation"  method="post"
                          class="kt-form" enctype="multipart/form-data" action="{{route('category.update',$editcategory->id)}}">
                          <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                ...
                                                <label class="col-3 col-form-label">{{__('adminMessage.is_full_width')}}</label>
													<div class="col-1">
														<span class="kt-switch">
															<label>
																<input type="checkbox"  name="is_full_width"  id="is_full_width" value="1" {{$editcategory->is_full_width==1?'checked':''}}/>
																<span></span>
															</label>
														</span>
													</div>
                                      ...
                                      <div class="form-group row">
                                                ...
                                                <label>{{__('adminMessage.seokeywords_en')}}</label>
                                                        <textarea rows="3" name="seo_keywords_en" class="form-control @if($errors->has('seo_keywords_en')) is-invalid @endif" autocomplete="off" placeholder="{{__('adminMessage.enterseokeywords_en')}}">{{$editcategory->seo_keywords_en?$editcategory->seo_keywords_en:old('seo_keywords_en')}}</textarea>
                                                ...
                                                <label>{{__('adminMessage.seokeywords_ar')}}</label>
                                                        <textarea dir="rtl" rows="3" name="seo_keywords_ar" class="form-control @if($errors->has('seo_keywords_ar')) is-invalid @endif" autocomplete="off" placeholder="{{__('adminMessage.enterseokeywords_ar')}}">{{$editcategory->seo_keywords_ar?$editcategory->seo_keywords_ar:old('seo_keywords_ar')}}</textarea>
                                    ...
                                    <div class="form-group row">
                                                ...
                                                <label>{{__('adminMessage.seodescription_en')}}</label>
                                                        <textarea rows="3" name="seo_description_en" class="form-control @if($errors->has('seo_description_en')) is-invalid @endif" autocomplete="off" placeholder="{{__('adminMessage.enterseodescription_en')}}">{{$editcategory->seo_description_en?$editcategory->seo_description_en:old('seo_description_en')}}</textarea>
                                                ...
                                                <label>{{__('adminMessage.seodescription_ar')}}</label>
                                                        <textarea dir="rtl" rows="3" name="seo_description_ar" class="form-control @if($errors->has('seo_description_ar')) is-invalid @endif" autocomplete="off" placeholder="{{__('adminMessage.enterseodescription_ar')}}">{{$editcategory->seo_description_ar?$editcategory->seo_description_ar:old('seo_description_ar')}}</textarea>
                                         ...
                                         <div class="form-group row">
                                                ...
                                                <label>{{__('adminMessage.friendlyurl')}}</label>
                                                        <input type="text" class="form-control @if($errors->has('friendly_url')) is-invalid @endif" name="friendly_url"
                                                               value="{{$editcategory->friendly_url?$editcategory->friendly_url:old('friendly_url')}}" autocomplete="off" placeholder="{{__('adminMessage.enterfirednlyurl')}}*" />
