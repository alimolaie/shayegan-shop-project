                         ...
                         <form name="tFrm"  id="form_validation"  method="post"
                          ...
                          <input type="hidden" name="_token" value="{{ csrf_token() }}">
											<div class="kt-portlet__body">
                                                ...
                                                <select class="form-control @if($errors->has('url')) is-invalid @endif" name="method">
                                             ...
                                             <div class="form-group row">   
                                                ...
                                                <input type="text" class="form-control @if($errors->has('parameters')) is-invalid @endif" name="parameters"
                                                               value="{{old('parameters')}}" autocomplete="off" placeholder="{{__('adminMessage.enter_parameters')}}" />
