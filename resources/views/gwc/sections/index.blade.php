										...
										<!--parent categories dropdown -->	
                                           <div class="form-group row">
                                                ...
                                                <div class="form-group row">
													...
													<div class="col-3">
														<input type="text" class="form-control @if($errors->has('display_order')) is-invalid @endif" name="display_order"  value="{{$SectionList->is_active?$SectionList->is_active:$lastOrder}}" autocomplete="off" />
