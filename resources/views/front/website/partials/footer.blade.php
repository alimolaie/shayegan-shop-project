    ...
    <div class="container">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="widget widget-about">
                        <a href="{{url('/')}}" class="logo-footer">
                            <img src="{{asset('uploads/logo/'.$setting->logo)}}" alt="logo-footer" width="144"
                                 height="45" />
                        </a>
                        <div class="widget-body">
                            ...
                            <div class="social-icons social-icons-colored">
                                <a href="{{$setting->	social_instagram}}" class="social-icon social-instagram w-icon-instagram"></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="footer-bottom">
            <div class="footer-left">
                <p class="copyright">{{$setting->copyrights_ar}}</p>
            </div>
        </div>
    </div>
</footer>