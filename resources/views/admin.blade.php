...
<head>
    ...
    <link type="text/css" href="{{asset('admin-login/css/font-awesome.min.css')}}" rel="stylesheet" />
    <link type="text/css" href="{{asset('admin-login/css/style.css')}}" rel="stylesheet" />
</head>
<body>
<div class="bg-contact2" style="background-image: url('admin-login/pics/bg-01.jpg');">
    <div class="container-contact2">
        <div class="wrap-contact2">
            <form class="contact2-form" method="post" action="{{url('gwc/login')}}">
                @csrf
...
<script src="{{asset('admin-login/js/jquery-3.1.1.min.js')}}"></script>
