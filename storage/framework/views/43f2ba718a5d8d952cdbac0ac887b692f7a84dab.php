...
<html lang="en">
	...
	<head>
		...
		<meta charset="utf-8" />
		<title><?php echo e(__('adminMessage.websiteName')); ?>|<?php echo e(__('adminMessage.state')); ?></title>
							...
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									...
									<div class="kt-subheader__breadcrumbs">
										...
										<span class="kt-subheader__breadcrumbs-separator"></span>
										<a href="javascript:;" class="kt-subheader__breadcrumbs-link"><?php echo e(__('adminMessage.statelisting')); ?></a>
                                        
									</div>
								</div>
								<div class="kt-subheader__toolbar">
									<form class="kt-margin-l-20" method="get" id="kt_subheader_search_form" action="<?php echo e(url('gwc/'.Request()->parent_id.'/state')); ?>">
									...
									<div class="btn-group">
										...
										<a href="<?php echo e(url('gwc/'.Request()->parent_id.'/state/create')); ?>" class="btn btn-brand btn-bold"><i class="la la-plus"></i>&nbsp;<?php echo e(__('adminMessage.createnew')); ?></a>
                                        <?php endif; ?>
							...
							<div class="kt-portlet kt-portlet--mobile">
								<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										...
										<h3 class="kt-portlet__head-title">
											<?php echo e(__('adminMessage.statelisting')); ?>
                                ...
                                <?php if(auth()->guard('admin')->user()->can('state-list')): ?>
									...
									<table class="table table-striped- table-bordered table-hover table-checkable " id="kt_table_1">
										...
										<tbody>
                                        <?php if(count($stateLists)): ?>
                                        <?php $p=1; ?>
                                        <?php $__currentLoopData = $stateLists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$stateList): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        $countstates = App\Http\Controllers\AdminCountryController::countCountryStateArea($stateList->id);
                                        ?>
											<tr class="search-body">
												<td><?php echo e($stateLists->firstItem() + $key); ?></td>
												<td><?php echo $stateList->name_en; ?></td>
												<td><?php echo $stateList->name_ar; ?></td>
												<td><?php echo $stateList->delivery_fee; ?></td>
												<td>
                                                <span class="kt-switch"><label><input value="<?php echo e($stateList->id); ?>" <?php echo e(!empty($stateList->is_active)?'checked':''); ?> type="checkbox"  id="state" class="change_status"><span></span></label></span>
                                                </td>
                                                ...
                                                <td class="kt-datatable__cell">
                                                 ...
                                                 <li class="kt-nav__item"><a href="<?php echo e(url('gwc/'.$stateList->id.'/area')); ?>" class="kt-nav__link"><i class="kt-nav__link-icon flaticon2-add"></i><span class="kt-nav__link-text"><?php echo e(__('adminMessage.listarea')); ?>(<?php echo e($countstates); ?>)</span></a></li>
                                              
                                                 <?php if(auth()->guard('admin')->user()->can('state-edit')): ?>
                                                 <li class="kt-nav__item"><a href="<?php echo e(url('gwc/'.Request()->parent_id.'/state/'.$stateList->id.'/edit')); ?>" class="kt-nav__link"><i class="kt-nav__link-icon flaticon2-contract"></i><span class="kt-nav__link-text"><?php echo e(__('adminMessage.edit')); ?></span></a></li>
                                                 <?php endif; ?>
                                                 <?php if(auth()->guard('admin')->user()->can('state-delete')): ?>
                                                 <li class="kt-nav__item"><a href="javascript:;" data-toggle="modal" data-target="#kt_modal_<?php echo e($stateList->id); ?>" class="kt-nav__link"><i class="kt-nav__link-icon flaticon2-trash"></i><span class="kt-nav__link-text"><?php echo e(__('adminMessage.delete')); ?></span></a></li>
                                                 <?php endif; ?>
                                                 </ul>
                                                 </div>
                                                 </div>
                                                 ...
                                                 <!--Delete modal -->
 <div class="modal fade" id="kt_modal_<?php echo e($stateList->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-footer">
											...
											<button type="button" class="btn btn-danger"  onClick="Javascript:window.location.href='<?php echo e(url('gwc/'.$stateList->parent_id.'/state/delete/'.$stateList->id)); ?>'"><?php echo e(__('adminMessage.yes')); ?></button>
										</div>
									</div>
								</div>
							</div>
                                        ...
                                        <tr><td colspan="6" class="text-center"><?php echo e($stateLists->links()); ?></td></tr> 
                                        <?php else: ?>
                                        <tr><td colspan="6" class="text-center"><?php echo e(__('adminMessage.recordnotfound')); ?></td></tr>
                                        <?php endif; ?>    
										</tbody>
									</table>
                            <?php else: ?>
	...
	<!-- end::Body -->
</html><?php /**PATH /home/kashkha/private/resources/views/gwc/state/index.blade.php ENDPATH**/ ?>