            ...
            <div class="container">
                <div class="login-popup">
                    <div class="tab tab-nav-boxed tab-nav-center tab-nav-underline">
                        ...
                        <form action="<?php echo e(url('login-member-test')); ?>" method="post">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('front.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\shayegan_project\shop\resources\views/front/website/login-test.blade.php ENDPATH**/ ?>