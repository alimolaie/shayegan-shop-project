...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title><?php echo e(__('adminMessage.websiteName')); ?>|<?php echo e(__('adminMessage.createsinglepages')); ?></title>
				...
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
					...
					<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
							...
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									...
									<div class="kt-subheader__breadcrumbs">
										...
										<a href="javascript:;" class="kt-subheader__breadcrumbs-link"><?php echo e(__('adminMessage.createsinglepages')); ?></a>
									</div>
								</div>
						...
						<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										...
										<h3 class="kt-portlet__head-title"><?php echo e(__('adminMessage.createsinglepages')); ?></h3>
									</div>
					...
					<?php if(auth()->guard('admin')->user()->can('singlepages-create')): ?>
                         ...
                         <form name="tFrm"  id="form_validation"  method="post"
                          class="kt-form" enctype="multipart/form-data" action="<?php echo e(route('singlepages.store')); ?>">
                                      ...
                                      <!--categories description -->          
                                            <div class="form-group row">
                                                ...
                                                <label><?php echo e(__('adminMessage.details_ar')); ?></label>
                                                        <textarea dir="rtl"   rows="3" id="details_ar" name="details_ar" class="kt-tinymce-4 form-control <?php if($errors->has('details_ar')): ?> is-invalid <?php endif; ?>" autocomplete="off" placeholder="<?php echo e(__('adminMessage.enter_details_ar')); ?>"><?php echo e(old('details_ar')); ?></textarea>
...
['fontname', ['fontname']],
	...
	<!-- end::Body -->
</html><?php /**PATH /home/kashkha/private/resources/views/gwc/singlepages/create.blade.php ENDPATH**/ ?>