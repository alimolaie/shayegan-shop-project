...
<html lang="en">
	...
	<head>
		...
		<meta charset="utf-8" />
		<title><?php echo e(__('adminMessage.websiteName')); ?>|<?php echo e(__('adminMessage.options')); ?></title>
							...
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									...
									<div class="kt-subheader__breadcrumbs">
										...
										<a href="javascript:;" class="kt-subheader__breadcrumbs-link"><?php echo e(__('adminMessage.optionslisting')); ?></a>
								...
								<div class="kt-subheader__toolbar">
									...
									<div class="btn-group">
                                        <?php if(auth()->guard('admin')->user()->can('options-create')): ?>
										<a href="<?php echo e(url('gwc/options/create')); ?>" class="btn btn-brand btn-bold"><i class="la la-plus"></i>&nbsp;<?php echo e(__('adminMessage.createnew')); ?></a>
                                        <?php endif; ?>
								...
								<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										...
										<h3 class="kt-portlet__head-title">
											<?php echo e(__('adminMessage.optionslisting')); ?>
                                ...
                                <?php if(auth()->guard('admin')->user()->can('options-list')): ?>
									...
									<table class="table table-striped- table-bordered table-hover table-checkable " id="kt_table_1">
										<thead>
											<tr>
												<th width="10">#</th>
                                                <th><?php echo e(__('adminMessage.option_name')); ?>(En)</th>
                                                <th><?php echo e(__('adminMessage.option_name')); ?>(Ar)</th>
                                                <th width="80"><?php echo e(__('adminMessage.type')); ?></th>
                                        ...
                                        <?php $__currentLoopData = $optionsLists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$optionsList): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<tr class="search-body">
												<td><?php echo e($optionsLists->firstItem() + $key); ?></td>
												<td><?php echo $optionsList->option_name_en; ?></td>
                                                <td><?php echo $optionsList->option_name_ar; ?></td>
												<td><?php echo $optionsList->option_type; ?></td>
												<td>
                                                <span class="kt-switch"><label><input value="<?php echo e($optionsList->id); ?>" <?php echo e(!empty($optionsList->is_active)?'checked':''); ?> type="checkbox"  id="options" class="change_status"><span></span></label></span>
                                                </td>
												<td><?php echo $optionsList->created_at; ?></td>
												<td><?php echo $optionsList->updated_at; ?></td>
                                                <td class="kt-datatable__cell">
                                                <?php if($optionsList->id>3): ?>
                                                 ...
                                                 <li class="kt-nav__item"><a href="<?php echo e(url('gwc/options/'.$optionsList->id.'/edit')); ?>" class="kt-nav__link"><i class="kt-nav__link-icon flaticon2-contract"></i><span class="kt-nav__link-text"><?php echo e(__('adminMessage.edit')); ?></span></a></li>
                                                 <?php endif; ?>
                                                 <?php if(auth()->guard('admin')->user()->can('options-delete')): ?>
                                                 <li class="kt-nav__item"><a href="javascript:;" data-toggle="modal" data-target="#kt_modal_<?php echo e($optionsList->id); ?>" class="kt-nav__link"><i class="kt-nav__link-icon flaticon2-trash"></i><span class="kt-nav__link-text"><?php echo e(__('adminMessage.delete')); ?></span></a></li>
                                                 <?php endif; ?>
                                                 </ul>
                                                 </div>
                                                 </div>
                                                 ...
                                                 <!--Delete modal -->
                                                   <div class="modal fade" id="kt_modal_<?php echo e($optionsList->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <button type="button" class="btn btn-danger"  onClick="Javascript:window.location.href='<?php echo e(url('gwc/options/delete/'.$optionsList->id)); ?>'"><?php echo e(__('adminMessage.yes')); ?></button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <tr><td colspan="8" class="text-center"><?php echo e($optionsLists->links()); ?></td></tr> 
                                        <?php else: ?>
	...
	<!-- end::Body -->
</html><?php /**PATH /home/gulfwebi/tikbazar.gulfweb.ir/resources/views/gwc/options/index.blade.php ENDPATH**/ ?>