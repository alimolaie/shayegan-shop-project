...
<html lang="en">
	...
	<head>
		...
		<meta charset="utf-8" />
		<title><?php echo e(__('adminMessage.websiteName')); ?>|<?php echo e(__('adminMessage.customerswish')); ?></title>
					...
					<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
						...
						<div class="kt-subheader   kt-grid__item" id="kt_subheader">
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									<h3 class="kt-subheader__title"><?php echo e(__('adminMessage.customerswish')); ?></h3>
									...
									<div class="kt-subheader__breadcrumbs">
										...
										<a href="javascript:;" class="kt-subheader__breadcrumbs-link"><?php echo e(__('adminMessage.customerswishlistings')); ?></a>
                                ...
                                <div class="btn-group">
										...
										<?php if(!empty($customersLists)): ?>
										    ...
										    <option value="<?php echo e($customersList->id); ?>" <?php if(!empty(Cookie::get('wish_customers')) && Cookie::get('wish_customers')==$customersList->id): ?> selected <?php endif; ?>><?php echo e($customersList->name); ?></option>
									...
									<form class="kt-margin-l-20" method="get" id="kt_subheader_search_form" action="<?php echo e(url('gwc/customers/wishitems')); ?>">
											<div class="kt-input-icon kt-input-icon--right kt-subheader__search">
												<input value="<?php echo e(Request()->q); ?>" type="text" class="form-control" placeholder="<?php echo e(__('adminMessage.searchhere')); ?>" id="searchCat" name="q">
						...
						<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
							...
							<div class="kt-portlet kt-portlet--mobile">
								<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										...
										<h3 class="kt-portlet__head-title">
											<?php echo e(__('adminMessage.wishListings')); ?>
                                ...
                                <?php if(auth()->guard('admin')->user()->can('wishitem-list')): ?>
									<!--begin: Datatable -->
									<table class="table table-striped- table-bordered table-hover table-checkable " id="kt_table_1">
										<thead>
											<tr>
                                                ...
                                                <th width="150"><?php echo e(__('adminMessage.item_code')); ?></th>
												<th width="150"><?php echo e(__('adminMessage.title')); ?></th>
                                                <th width="150"><?php echo e(__('adminMessage.retail_price')); ?></th>
                                        ...
                                        <?php $__currentLoopData = $wishLists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$wishList): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<tr class="search-body">
												<td><?php echo e($wishLists->firstItem() + $key); ?></td>
												<td>
                                                <?php if($wishList->image): ?>
                                                <img src="<?php echo url('uploads/product/thumb/'.$wishList->image); ?>" width="40">
                                                <?php else: ?>
                                                <img src="<?php echo url('uploads/no-image.png'); ?>" width="40">
                                                <?php endif; ?>
                                                </td>
                                                <td><?php echo $wishList->item_code; ?></td>
												<td><?php echo $wishList->title_en; ?></td>
												<td><?php echo $wishList->retail_price; ?></td>
												<td><?php echo $wishList->created_at; ?></td>
												
                                                <td class="kt-datatable__cell">
                                                 <?php if(auth()->guard('admin')->user()->can('wishitem-delete')): ?>
                                                 <a href="javascript:;" data-toggle="modal" data-target="#kt_modal_<?php echo e($wishList->id); ?>" class="kt-nav__link"><i class="kt-nav__link-icon flaticon2-trash"></i><span class="kt-nav__link-text"><?php echo e(__('adminMessage.delete')); ?></span></a>
                                                 <?php endif; ?>
                                                 
                                                 <!--Delete modal -->
 <div class="modal fade" id="kt_modal_<?php echo e($wishList->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-footer">
											...
											<button type="button" class="btn btn-danger"  onClick="Javascript:window.location.href='<?php echo e(url('gwc/customers/wishitems/delete/'.$wishList->id)); ?>'"><?php echo e(__('adminMessage.yes')); ?></button>
										</div>
									</div>
								</div>
							</div>
                                        ...
                                        <?php $p++; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>   
                                        <tr><td colspan="10" class="text-center"><?php echo e($wishLists->links()); ?></td></tr> 
                                        <?php else: ?>
	...
	<!-- end::Body -->
</html><?php /**PATH /home/gulfwebi/tikbazar.gulfweb.ir/resources/views/gwc/customers/wishitems.blade.php ENDPATH**/ ?>