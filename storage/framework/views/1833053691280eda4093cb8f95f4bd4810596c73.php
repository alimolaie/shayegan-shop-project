...
<html lang="en">
						...
						<div class="kt-subheader   kt-grid__item" id="kt_subheader">
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									<h3 class="kt-subheader__title"><?php echo e("Intro"); ?></h3>
									...
									<div class="kt-subheader__breadcrumbs">
										...
										<a href="javascript:;" class="kt-subheader__breadcrumbs-link"><?php echo e("Intro List"); ?></a>
								...
								<div class="kt-subheader__toolbar">
									...
									<div class="btn-group">
										...
										<a href="<?php echo e(url('admin/intro/create')); ?>" class="btn btn-brand btn-bold"><i class="la la-plus"></i>&nbsp;<?php echo e("Create New"); ?></a>
                                        <?php endif; ?>
									...
									<table class="table table-striped- table-bordered table-hover table-checkable " id="kt_table_1">
                                        ...
                                        <?php $__currentLoopData = $couponLists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$couponList): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<tr class="search-body">
												...
												<td><?php echo $couponList->title; ?></td>
												<td><?php echo $couponList->icon; ?></td>
                                                <td><?php echo $couponList->description; ?></td>
	...
	<!-- end::Body -->
</html><?php /**PATH E:\shayegan_project\shop\resources\views/gwc/intro/index.blade.php ENDPATH**/ ?>