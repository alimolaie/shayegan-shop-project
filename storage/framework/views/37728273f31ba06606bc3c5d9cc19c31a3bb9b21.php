...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title><?php echo e(__('adminMessage.websiteName')); ?>|<?php echo e(__('adminMessage.createsize')); ?></title>
				...
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
					...
					<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
							...
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									...
									<div class="kt-subheader__breadcrumbs">
										...
										<a href="javascript:;" class="kt-subheader__breadcrumbs-link"><?php echo e(__('adminMessage.createsize')); ?></a>
									</div>
								</div>
								<div class="btn-group" style="margin-top:10px;">
                                <?php if(auth()->guard('admin')->user()->can('size-list')): ?>
												<a href="<?php echo e(url('gwc/size')); ?>" class="btn btn-brand btn-elevate btn-icon-sm"><i class="la la-list-ul"></i><?php echo e(__('adminMessage.listsize')); ?></a> <?php endif; ?>
                                </div>
							</div>
						</div>
						...
						<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										...
										<h3 class="kt-portlet__head-title"><?php echo e(__('adminMessage.createsize')); ?></h3>
									</div>
					...
					<?php if(auth()->guard('admin')->user()->can('size-create')): ?>
                         ...
                         <form name="tFrm"  id="form_validation"  method="post"
                          class="kt-form" enctype="multipart/form-data" action="<?php echo e(route('size.store')); ?>">
                                         ...
                                         <div class="form-group row">
											...
											<div class="kt-portlet__foot">
												<div class="kt-form__actions">
													...
													<button type="button" onClick="Javascript:window.location.href='<?php echo e(url('gwc/size')); ?>'"  class="btn btn-secondary cancelbtn"><?php echo e(__('adminMessage.cancel')); ?></button>
												</div>
											</div>
										</form>
...
['fontname', ['fontname']],
	...
	<!-- end::Body -->
</html><?php /**PATH /home/kashkha/private/resources/views/gwc/size/create.blade.php ENDPATH**/ ?>