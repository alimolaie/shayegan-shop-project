...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title><?php echo e(__('adminMessage.websiteName')); ?>|<?php echo e(__('adminMessage.editcoupon')); ?></title>
					...
					<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
							...
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									...
									<div class="kt-subheader__breadcrumbs">
										...
										<a href="javascript:;" class="kt-subheader__breadcrumbs-link"><?php echo e(__('adminMessage.editcoupon')); ?></a>
									</div>
								</div>
						...
						<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										...
										<h3 class="kt-portlet__head-title"><?php echo e(__('adminMessage.editcoupon')); ?></h3>
									</div>
									
								</div>				
										<!--begin::Form-->
					<?php if(auth()->guard('admin')->user()->can('coupon-edit')): ?>
                    <form name="tFrm"  id="form_validation"  method="post"
                          class="kt-form" enctype="multipart/form-data" action="<?php echo e(route('coupon.update',$editcoupon->id)); ?>">
                          <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
											<div class="kt-portlet__body">
                                                ...
                                                <input type="text" class="form-control <?php if($errors->has('title_en')): ?> is-invalid <?php endif; ?>" name="title_en"
                                                               value="<?php echo e($editcoupon->title_en?$editcoupon->title_en:old('title_en')); ?>" autocomplete="off" placeholder="<?php echo e(__('adminMessage.enter_title_en')); ?>*" />
                                                ...
                                                <input type="text" class="form-control <?php if($errors->has('title_ar')): ?> is-invalid <?php endif; ?>" name="title_ar"
                                                               value="<?php echo e($editcoupon->title_ar?$editcoupon->title_ar:old('title_ar')); ?>" autocomplete="off" placeholder="<?php echo e(__('adminMessage.enter_title_ar')); ?>*" />
                                                ...
                                                <div class="form-group row">
													...
													<div class="col-3">
														<span class="kt-switch">
															<label>
																<input type="checkbox" <?php echo e($editcoupon->is_active==1?'checked':''); ?> name="is_active"  id="is_active" value="1"/>
																<span></span>
															</label>
														</span>
													</div>
													...
													<div class="col-3">
														<span class="kt-switch">
															<label>
																<input type="checkbox"  <?php echo e($editcoupon->is_free==1?'checked':''); ?> name="is_free"  id="is_free" value="1"/>
																<span></span>
															</label>
														</span>
													</div>
                                         ...
                                         <div class="form-group row">
                                                ...
                                                <input type="text" class="form-control <?php if($errors->has('coupon_code')): ?> is-invalid <?php endif; ?>" name="coupon_code" value="<?php echo e($editcoupon->coupon_code?$editcoupon->coupon_code:old('coupon_code')); ?>" autocomplete="off" placeholder="<?php echo e(__('adminMessage.enter_coupon_code')); ?>*" />
                                                ...
                                                <option value="amt" <?php if($editcoupon->coupon_type=='amt'): ?> selected <?php endif; ?>><?php echo e(__('adminMessage.amountkd')); ?></option>
                                                <option value="per" <?php if($editcoupon->coupon_type=='per'): ?> selected <?php endif; ?>><?php echo e(__('adminMessage.percentage')); ?></option>
                                                </select>
                                                <?php if($errors->has('coupon_code')): ?>
                                                <div class="invalid-feedback"><?php echo e($errors->first('coupon_code')); ?></div>
                                                <?php endif; ?>
                                                ...
                                                <input type="text" class="form-control <?php if($errors->has('coupon_value')): ?> is-invalid <?php endif; ?>" name="coupon_value"
                                                               value="<?php echo e($editcoupon->coupon_value?$editcoupon->coupon_value:old('coupon_value')); ?>" autocomplete="off" placeholder="<?php echo e(__('adminMessage.enter_coupon_value')); ?>*" />
                                                ...
                                                <label><?php echo e(__('adminMessage.date_range')); ?></label>
													<div class="input-group">
														<input type="text" class="datepick form-control <?php if($errors->has('start_date')): ?> is-invalid <?php endif; ?>" name="start_date" value="<?php echo e($editcoupon->start_date?$editcoupon->start_date:old('start_date')); ?>" autocomplete="off" placeholder="<?php echo e(__('adminMessage.start_date')); ?>*" />
														<input type="text" class=" datepick form-control <?php if($errors->has('end_date')): ?> is-invalid <?php endif; ?>" name="end_date"
                                                               value="<?php echo e($editcoupon->end_date?$editcoupon->end_date:old('end_date')); ?>" autocomplete="off" placeholder="<?php echo e(__('adminMessage.end_date')); ?>*" />
													</div>
                                                ...
                                                <label><?php echo e(__('adminMessage.price_range')); ?></label>
													<div class="input-group">
														<input type="text" class="form-control <?php if($errors->has('price_start')): ?> is-invalid <?php endif; ?>" name="price_start" value="<?php echo e($editcoupon->price_start?$editcoupon->price_start:old('price_start')); ?>" autocomplete="off" placeholder="<?php echo e(__('adminMessage.price_start')); ?>*" />
														<input type="text" class="form-control <?php if($errors->has('price_end')): ?> is-invalid <?php endif; ?>" name="price_end"
                                                               value="<?php echo e($editcoupon->price_end?$editcoupon->price_end:old('price_end')); ?>" autocomplete="off" placeholder="<?php echo e(__('adminMessage.price_end')); ?>*" />
													</div>
                                               ...
                                               <div class="form-group row">
                                                ...
                                                <input type="text" class="form-control <?php if($errors->has('usage_limit')): ?> is-invalid <?php endif; ?>" name="usage_limit" value="<?php echo e($editcoupon->usage_limit?$editcoupon->usage_limit:old('usage_limit')); ?>" autocomplete="off" placeholder="<?php echo e(__('adminMessage.enter_usage_limit')); ?>*" />
                                                ...
                                                <option value="web" <?php if($editcoupon->is_for=='web'): ?> selected <?php endif; ?>><?php echo e(__('adminMessage.web')); ?></option>
                                                <option value="app" <?php if($editcoupon->is_for=='app'): ?> selected <?php endif; ?>><?php echo e(__('adminMessage.app')); ?></option>
                                                </select>
	...
	<!-- end::Body -->
</html><?php /**PATH /home/gulfwebi/tikbazar.gulfweb.ir/resources/views/gwc/coupon/edit.blade.php ENDPATH**/ ?>