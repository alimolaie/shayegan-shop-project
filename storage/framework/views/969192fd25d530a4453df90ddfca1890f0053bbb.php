...
<head>
    <meta charset="utf-8" />
    <title><?php echo e(__('adminMessage.websiteName')); ?>|<?php echo e(__('adminMessage.createcurrency')); ?></title>
                    ...
                    <div class="kt-container  kt-container--fluid ">
                        <div class="kt-subheader__main">
                            ...
                            <div class="kt-subheader__breadcrumbs">
                                ...
                                <a href="javascript:;" class="kt-subheader__breadcrumbs-link"><?php echo e(__('adminMessage.createcurrency')); ?></a>
                            </div>
                        </div>
                    ...
                    <div class="kt-portlet">
                        <div class="kt-portlet__head kt-portlet__head--lg">
                            <div class="kt-portlet__head-label">
                                ...
                                <h3 class="kt-portlet__head-title"><?php echo e(__('adminMessage.createcurrency')); ?></h3>
                            </div>
                        ...
                        <?php if(auth()->guard('admin')->user()->can('currency-create')): ?>
                            ...
                            <form name="tFrm"  id="form_validation"  method="post"
                                  class="kt-form" enctype="multipart/form-data" action="<?php echo e(route('currency.store')); ?>">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-4">
                                            ...
                                            <input type="text" class="form-control <?php if($errors->has('currency_code')): ?> is-invalid <?php endif; ?>" name="currency_code"
                                                   value="<?php echo e(old('currency_code')); ?>" autocomplete="off" placeholder="<?php echo e(__('adminMessage.enter_currency_code')); ?>" />
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <input type="text" class="form-control <?php if($errors->has('exchange_rate')): ?> is-invalid <?php endif; ?>" name="exchange_rate"
                                                   value="<?php echo e(old('exchange_rate')); ?>" autocomplete="off" placeholder="<?php echo e(__('adminMessage.enter_exchange_rate')); ?>" />
...
<!-- end::Body -->
</html><?php /**PATH C:\xampp\htdocs\tikbazar\resources\views/gwc/currency/create.blade.php ENDPATH**/ ?>