...
<head>
<meta charset="utf-8">
<title><?php if(app()->getLocale()=="en"): ?> <?php echo e($settingInfo->name_en); ?> <?php else: ?> <?php echo e($settingInfo->name_ar); ?> <?php endif; ?> | <?php echo e(__('webMessage.editaddress')); ?></title>
...
<div class="tt-breadcrumb">
	<div class="container">
		<ul>
			...
			<li><?php echo e(__('webMessage.editaddress')); ?></li>
		</ul>
	</div>
</div>
<div id="tt-pageContent">
	<div class="container-indent">
		<div class="container">
			<h1 class="tt-title-subpages noborder"><?php echo e(__('webMessage.editaddress')); ?></h1>
						...
						<div class="tt-item">
                            ...
                            <div class="row">
                               <div class="col-xs-8 col-md-8 col-lg-8">
								<form id="customer_reg_form" method="post" action="<?php echo e(route('editaddressSave',$editAddress->id)); ?>" enctype="multipart/form-data">
                                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                    <div class="row">
                                    <div class="col-xs-12 col-md-6 col-lg-4">
                                    <div class="form-group">
                                    <label for="title"><?php echo e(__('webMessage.title')); ?><font color="#FF0000">*</font></label>
									<input type="text" name="title"  class="form-control" id="title" placeholder="<?php echo e(__('webMessage.enter_title')); ?>" autcomplete="off" value="<?php if(old('title')): ?> <?php echo e(old('title')); ?> <?php else: ?> <?php echo e($editAddress->title); ?> <?php endif; ?>">
									...
									<input type="text" name="latitude"  class="form-control" id="latitude" placeholder="<?php echo e(__('webMessage.enter_latitude')); ?>" autcomplete="off" value="<?php if(old('latitude')): ?> <?php echo e(old('latitude')); ?><?php else: ?> <?php echo e($editAddress->latitude); ?> <?php endif; ?>">
									...
									<input type="text" name="longitude"  class="form-control" id="longitude" placeholder="<?php echo e(__('webMessage.enter_longitude')); ?>" autcomplete="off" value="<?php if(old('longitude')): ?> <?php echo e(old('longitude')); ?><?php else: ?> <?php echo e($editAddress->longitude); ?> <?php endif; ?>">
                                    ...
                                    <option value="<?php echo e($countryList->id); ?>" <?php if((!empty(old('country')) && old('country')==$countryList->id) || (!empty($editAddress->country_id) && $editAddress->country_id==$countryList->id)): ?> selected <?php endif; ?>><?php echo e($countryList['name_'.$strLang]); ?></option>
                                    ...
                                    <?php if(!empty($editAddress->country_id)): ?>
                                    <?php
                                    ...
                                    <option value="<?php echo e($stateList->id); ?>" <?php if((!empty(old('state')) && old('state')==$stateList->id) || (!empty($editAddress->state_id) && $editAddress->state_id==$stateList->id)): ?> selected <?php endif; ?>><?php echo e($stateList['name_'.$strLang]); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>
                                    </select>
                                    ...
                                    <?php if(!empty($editAddress->state_id)): ?>
                                    <?php
                                    ...
                                    <option value="<?php echo e($areaList->id); ?>" <?php if((!empty(old('area')) && old('area')==$areaList->id) || (!empty($editAddress->area_id) && $editAddress->area_id==$areaList->id)): ?> selected <?php endif; ?>><?php echo e($areaList['name_'.$strLang]); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>
                                    </select>
									...
									<input type="text" name="block"  class="form-control" id="block" placeholder="<?php echo e(__('webMessage.enter_block')); ?>" autcomplete="off" value="<?php if(old('block')): ?> <?php echo e(old('block')); ?> <?php else: ?> <?php echo e($editAddress->block); ?>  <?php endif; ?>">
                                    ...
                                    <input type="text" name="street"  class="form-control" id="street" placeholder="<?php echo e(__('webMessage.enter_street')); ?>" autcomplete="off" value="<?php if(old('street')): ?> <?php echo e(old('street')); ?>  <?php else: ?> <?php echo e($editAddress->street); ?> <?php endif; ?>">
                                    ...
                                    <input type="text" name="avenue"  class="form-control" id="avenue" placeholder="<?php echo e(__('webMessage.enter_avenue')); ?>" autcomplete="off" value="<?php if(old('avenue')): ?> <?php echo e(old('avenue')); ?>  <?php else: ?> <?php echo e($editAddress->avenue); ?> <?php endif; ?>">
                                    ...
                                    <input type="text" name="house"  class="form-control" id="house" placeholder="<?php echo e(__('webMessage.enter_house')); ?>" autcomplete="off" value="<?php if(old('house')): ?> <?php echo e(old('house')); ?>  <?php else: ?> <?php echo e($editAddress->house); ?> <?php endif; ?>">
									...
									<input type="text" name="floor"  class="form-control" id="floor" placeholder="<?php echo e(__('webMessage.enter_floor')); ?>" autcomplete="off" value="<?php if(old('floor')): ?> <?php echo e(old('floor')); ?>  <?php else: ?> <?php echo e($editAddress->floor); ?> <?php endif; ?>">
                                    ...
                                    <div class="col-xs-12 col-md-6 col-lg-4">
                                    <div class="form-group">
                                    <label for="is_default" style="margin-top:10px;"><input type="checkbox" name="is_default"  id="is_default" autcomplete="off" value="1" <?php if(!empty($editAddress->is_default)): ?> checked <?php endif; ?> >&nbsp;<?php echo e(__('webMessage.default_address')); ?></label>
...
<!-- map -->
  ...
  const myLatlng = { lat: <?php echo e($latitude); ?> , lng: <?php echo e($longitude); ?> };
...
</html><?php /**PATH /home/kashkha/private/resources/views/website/editaddress.blade.php ENDPATH**/ ?>