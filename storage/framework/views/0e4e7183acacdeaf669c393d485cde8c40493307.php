...
use Illuminate\Support\Facades\Auth;
 ?>
                ...
                <?php if(Auth::guard('member')->check()==true): ?>
                    <a href="<?php echo e(url('users/my-account')); ?>" class="d-lg-show">حساب من </a>
                <?php else: ?>
                    <a href="<?php echo e(url('users/login')); ?>" class="d-lg-show login sign-in"><i
    ...
    <div class="header-middle">
        <div class="container">
            <div class="header-left mr-md-4">
                ...
                <a href="<?php echo e(url('/')); ?>" class="logo ml-lg-0">
                    <img src="<?php echo e(asset('uploads/logo/'.$setting->logo)); ?>" alt="logo" width="144" height="45" />
                </a>
                <nav class="main-nav">
                    <ul class="menu">
                        <li class="active">
                            <a href="<?php echo e(url('/')); ?>">خانه </a>
                        </li>
            ...
            <div class="header-right ml-4">
                <div class="header-call d-xs-show d-lg-flex align-items-center">
                    ...
                    <div class="call-info d-xl-show">
                        ...
                        <a href="tel:<?php echo e($setting->mobile); ?>" class="phone-number font-weight-bolder ls-50"><?php echo e($setting->mobile); ?></a>
                    </div>
                </div>
                ...
                <?php if(session('cart')): ?>
                    <div class="dropdown cart-dropdown mr-0 mr-lg-2">
                        ...
                        <a href="#" class="cart-toggle label-down link">
                            <i class="w-icon-cart">
                                <span class="cart-count"><?php echo e(array_sum(array_column(session('cart'), 'qty'))); ?></span>
                            </i>
                        ...
                        <div class="dropdown-box">
                            <div class="products">
                                ...
                                <div class="product product-cart" id="cart-<?php echo e($id); ?>">
                                    <div class="product-detail">
                                        <a href="<?php echo e(url('product/'.$id)); ?>" class="product-name"><?php echo e($details['title_ar']); ?></a>
                                        <div class="price-box">
                                            <span class="product-quantity"><?php echo e($details['qty']); ?></span>
                                            <span class="product-price"><?php echo e(number_format($details['retail_price'])); ?>  تومان</span>
                                        </div>
                                    </div>
                                    <figure class="product-media">
                                        <a href="<?php echo e(url('product/'.$id)); ?>">
                                            <img src="<?php echo e(asset('uploads/product/original/'.$details['image'])); ?>" alt="product" height="84"
                                                 width="94" />
                                        </a>
                                    </figure>
                            ...
                            <div class="cart-total">
                                <label>مجموع: </label>
                                <span class="price"><?php echo e(number_format($total)); ?> تومان</span>
                            </div>
<?php
    $a=0;
    $a+=$total;
 ?>
                            <?php if(session()->has('errors')): ?>
                                <div class="alert alert-danger animated fadeIn text-center">
                                    ...
                                    <strong>
                                        <?php echo session('cart')->get('errors'); ?>

                                    </strong>
                                </div>
                            <?php endif; ?>
                            <div class="cart-action">
                                <a href="<?php echo e(url('users/my-cart')); ?>" class="btn btn-dark btn-outline btn-rounded">سبد خرید </a>
...
<?php /**PATH E:\shayegan_project\shop\resources\views/front/website/partials/header.blade.php ENDPATH**/ ?>