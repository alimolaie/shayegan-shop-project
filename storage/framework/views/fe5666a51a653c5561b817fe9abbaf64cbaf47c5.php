...
<html lang="en">
	...
	<head>
		...
		<meta charset="utf-8" />
		<title><?php echo e(__('adminMessage.websiteName')); ?>|<?php echo e(__('adminMessage.subjects')); ?></title>
					...
					<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
						...
						<div class="kt-subheader   kt-grid__item" id="kt_subheader">
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									<h3 class="kt-subheader__title"><?php echo e(__('adminMessage.subjects')); ?></h3>
									...
									<div class="kt-subheader__breadcrumbs">
										...
										<a href="javascript:;" class="kt-subheader__breadcrumbs-link"><?php echo e(__('adminMessage.subjectslisting')); ?></a>
								...
								<div class="kt-subheader__toolbar">
									...
									<div class="btn-group">
                                        <?php if(auth()->guard('admin')->user()->can('subject-create')): ?>
						...
						<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
							...
							<div class="kt-portlet kt-portlet--mobile">
								<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										...
										<h3 class="kt-portlet__head-title">
											<?php echo e(__('adminMessage.subjectslisting')); ?>
                                ...
                                <?php if(auth()->guard('admin')->user()->can('subject-list')): ?>
									<!--begin: Datatable -->
									<table class="table table-striped- table-bordered table-hover table-checkable " id="kt_table_1">
                                        ...
                                        <?php $p=1; ?>
                                        <?php $__currentLoopData = $SubjectLists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$SubjectList): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<tr class="search-body">
												<td><?php echo e($SubjectLists->firstItem() + $key); ?></td>
												<td><?php echo $SubjectList->title_en; ?></td>
												<td><?php echo $SubjectList->title_en; ?></td>
												
												<td>
                                                <span class="kt-switch"><label><input value="<?php echo e($SubjectList->id); ?>" <?php echo e(!empty($SubjectList->is_active)?'checked':''); ?> type="checkbox"  id="subjects" class="change_status"><span></span></label></span>
                                                </td>
												<td><?php echo $SubjectList->created_at; ?></td>
												<td><?php echo $SubjectList->updated_at; ?></td>
                                                <td class="kt-datatable__cell" align="center">
                                                 <?php if(auth()->guard('admin')->user()->can('subject-delete')): ?>
                                                 <a title="<?php echo e(__('adminMessage.delete')); ?>" href="javascript:;" data-toggle="modal" data-target="#kt_modal_<?php echo e($SubjectList->id); ?>" class="kt-nav__link"><i class="kt-nav__link-icon flaticon2-trash"></i><span class="kt-nav__link-text"></span></a>
                                                 <?php endif; ?>
                                                 
                                                 <!--Delete modal -->
                       <div class="modal fade" id="kt_modal_<?php echo e($SubjectList->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-footer">
											...
											<button type="button" class="btn btn-danger"  onClick="Javascript:window.location.href='<?php echo e(url('gwc/contactus/subjects/delete/'.$SubjectList->id)); ?>'"><?php echo e(__('adminMessage.yes')); ?></button>
										</div>
									</div>
								</div>
							</div>
                                        ...
                                        <tr><td colspan="8" class="text-center"><?php echo e($SubjectLists->links()); ?></td></tr> 
                                        <?php else: ?>
        ...
        <!--begin::Modal-->
					...
					<?php if(auth()->guard('admin')->user()->can('subject-create')): ?>
                         ...
                         <form name="tFrm"  id="form_validation"  method="post"
                          class="kt-form" enctype="multipart/form-data" action="<?php echo e(route('saveSubject')); ?>">
	...
	<!-- end::Body -->
</html><?php /**PATH /home/gulfwebi/tikbazar.gulfweb.ir/resources/views/gwc/contactus/subjects.blade.php ENDPATH**/ ?>