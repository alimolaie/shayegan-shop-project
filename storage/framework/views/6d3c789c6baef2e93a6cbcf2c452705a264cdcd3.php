...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title><?php echo e(__('adminMessage.websiteName')); ?>|<?php echo e(__('adminMessage.createnewcustomers')); ?></title>
				...
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
					...
					<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
							...
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									...
									<div class="kt-subheader__breadcrumbs">
										...
										<a href="javascript:;" class="kt-subheader__breadcrumbs-link"><?php echo e(__('adminMessage.createnewcustomers')); ?></a>
									</div>
								</div>
								<?php if(auth()->guard('admin')->user()->can('customers-list')): ?>
								<a style="margin-top:10px;" href="<?php echo e(url('gwc/customers')); ?>" class="btn btn-brand btn-elevate btn-icon-sm"><i class="la la-list-ul"></i><?php echo e(__('adminMessage.listcustomers')); ?></a><?php endif; ?>
							</div>
						</div>
						...
						<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										...
										<h3 class="kt-portlet__head-title"><?php echo e(__('adminMessage.createnewcustomers')); ?></h3>
									</div>
					...
					<?php if(auth()->guard('admin')->user()->can('customers-create')): ?>
                         ...
                         <form name="tFrm"  id="form_validation"  method="post"
                          class="kt-form" enctype="multipart/form-data" action="<?php echo e(route('customers.store')); ?>">
                          <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                         ...
                                         <div class="col-lg-4">
                                                ...
                                                <input type="text" class="form-control <?php if($errors->has('mobile1')): ?> is-invalid <?php endif; ?>" name="mobile"
                                                               value="<?php echo e(old('mobile')); ?>" autocomplete="off" placeholder="<?php echo e(__('adminMessage.enter_mobile')); ?>*" />
                                         ...
                                         <div class="form-group"><h5><?php echo e(__('adminMessage.logininformation')); ?></h5></div>   
                                          <div class="form-group row">
                                             
                                                <div class="col-lg-4">
                                                <label><?php echo e(__('adminMessage.username')); ?></label>
                                                <input type="text" class="form-control <?php if($errors->has('username')): ?> is-invalid <?php endif; ?>" name="username"
                                                               value="<?php echo e(old('username')); ?>" autocomplete="off" placeholder="<?php echo e(__('adminMessage.enter_username')); ?>*" />
                                                               <?php if($errors->has('username')): ?>
                                                               <div class="invalid-feedback"><?php echo e($errors->first('username')); ?></div>
                                                               <?php endif; ?>
                                                </div>
                                                <div class="col-lg-4">
                                                <label><?php echo e(__('adminMessage.password')); ?></label>
                                                <input type="password" class="form-control <?php if($errors->has('password')): ?> is-invalid <?php endif; ?>" name="password"
                                                               value="<?php echo e(old('password')); ?>" autocomplete="off" placeholder="<?php echo e(__('adminMessage.enter_password')); ?>*" />
...
['fontname', ['fontname']],
	...
	<!-- end::Body -->
</html><?php /**PATH /home/kashkha/private/resources/views/gwc/customers/create.blade.php ENDPATH**/ ?>