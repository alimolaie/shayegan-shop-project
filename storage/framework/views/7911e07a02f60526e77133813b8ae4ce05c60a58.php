...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title><?php echo e(__('adminMessage.websiteName')); ?> | <?php echo e(__('adminMessage.createnewrole')); ?></title>
				...
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
							...
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									...
									<div class="kt-subheader__breadcrumbs">
										...
										<a href="javascript:;" class="kt-subheader__breadcrumbs-link"><?php echo e(__('adminMessage.createnewrole')); ?></a>
									</div>
								</div>
					...
					<?php if(auth()->guard('admin')->user()->can('role-create')): ?>
                         ...
                         <form name="tFrm"  id="form_validation"  method="post"
                          class="kt-form" enctype="multipart/form-data" action="<?php echo e(route('roles.store')); ?>">
											...
											<div class="form-group row"><h6><?php echo e(__('adminMessage.rolename')); ?></h6></div> 	
                                                ...
                                                <div class="col-lg-6">
                                                        <input type="text" class="form-control <?php if($errors->has('name')): ?> is-invalid <?php endif; ?>" name="name"
                                                               value="<?php echo e(old('name')); ?>" autocomplete="off" placeholder="<?php echo e(__('adminMessage.enterrolename')); ?>" />
                                                 ...
                                                 <div class="kt-checkbox-list kt-checkbox-inline">
                                                    ...
                                                    <?php $__currentLoopData = $permission; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                       <div class="col-lg-3">
                                                        ...
                                                        <input type="checkbox" name="permission[]" id="per-<?php echo e($value->id); ?>" value="<?php echo e($value->id); ?>">
	...
	<!-- end::Body -->
</html><?php /**PATH /home/kashkha/private/resources/views/gwc/roles/create.blade.php ENDPATH**/ ?>