...
<html lang="en">
	...
	<head>
		...
		<meta charset="utf-8" />
		<title><?php echo e(__('adminMessage.websiteName')); ?>|<?php echo e(__('adminMessage.contactus')); ?></title>
					...
					<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
						...
						<div class="kt-subheader   kt-grid__item" id="kt_subheader">
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									<h3 class="kt-subheader__title"><?php echo e(__('adminMessage.contactus')); ?></h3>
									...
									<div class="kt-subheader__breadcrumbs">
										...
										<a href="javascript:;" class="kt-subheader__breadcrumbs-link"><?php echo e(__('adminMessage.contactuslisting')); ?></a>
						...
						<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
							...
							<div class="kt-portlet kt-portlet--mobile">
								<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										...
										<h3 class="kt-portlet__head-title">
											<?php echo e(__('adminMessage.contactuslisting')); ?>
                                ...
                                <?php if(auth()->guard('admin')->user()->can('contactus-list')): ?>
									<!--begin: Datatable -->
									<table class="table table-striped- table-bordered table-hover table-checkable " id="kt_table_1">
										...
										<tbody>
                                        <?php if(count($ContactLists)): ?>
                                        <?php $p=1;$subjectName=''; ?>
                                        <?php $__currentLoopData = $ContactLists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$ContactList): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        $subjectName = App\Http\Controllers\AdminInboxController::getSubjectName($ContactList->subject);
                                        ?>
											<tr class="search-body">
												<td><?php echo e($ContactLists->firstItem() + $key); ?></td>
												<td><?php echo e($ContactList->name); ?></td>
                                                <td><?php echo e($subjectName); ?></td>

												<td><?php echo e($ContactList->email); ?></td>
												<td><?php echo e($ContactList->mobile); ?></td>
												<td><?php echo e($ContactList->created_at); ?></td>
                                                <td class="kt-datatable__cell">
                                                 ...
                                                 <ul class="kt-nav">
                                                 <?php if(auth()->guard('admin')->user()->can('contactus-view')): ?>
                                                 <li class="kt-nav__item"><a href="<?php echo e(url('gwc/contactus/'.$ContactList->id.'/view')); ?>" class="kt-nav__link"><i class="kt-nav__link-icon flaticon-eye"></i><span class="kt-nav__link-text"><?php echo e(__('adminMessage.view')); ?></span></a></li>
                                                 <?php endif; ?>
                                                 <?php if(auth()->guard('admin')->user()->can('contactus-delete')): ?>
                                                 <li class="kt-nav__item"><a href="javascript:;" data-toggle="modal" data-target="#kt_modal_<?php echo e($ContactList->id); ?>" class="kt-nav__link"><i class="kt-nav__link-icon flaticon2-trash"></i><span class="kt-nav__link-text"><?php echo e(__('adminMessage.delete')); ?></span></a></li>
                                                 <?php endif; ?>
                                                 </ul>
                                                 </div>
                                                 </div>
                                                 ...
                                                 <!--Delete modal -->
 <div class="modal fade" id="kt_modal_<?php echo e($ContactList->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-footer">
											...
											<button type="button" class="btn btn-danger"  onClick="Javascript:window.location.href='<?php echo e(url('gwc/contactus/inbox/delete/'.$ContactList->id)); ?>'"><?php echo e(__('adminMessage.yes')); ?></button>
										</div>
									</div>
								</div>
							</div>
                                        ...
                                        <tr><td colspan="8" class="text-center"><?php echo e($ContactLists->links()); ?></td></tr> 
                                        <?php else: ?>
	...
	<!-- end::Body -->
</html><?php /**PATH /home/gulfwebi/tikbazar.gulfweb.ir/resources/views/gwc/contactus/index.blade.php ENDPATH**/ ?>