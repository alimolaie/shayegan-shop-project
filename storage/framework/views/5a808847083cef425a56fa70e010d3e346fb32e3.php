...
<head>
<meta charset="utf-8">
<title><?php if(app()->getLocale()=="en"): ?> <?php echo e($settingInfo->name_en); ?> <?php else: ?> <?php echo e($settingInfo->name_ar); ?> <?php endif; ?> | <?php if(app()->getLocale()=="en" && $categoryDetails->name_en): ?> <?php echo e($categoryDetails->name_en); ?> <?php elseif(app()->getLocale()=="ar" && $categoryDetails->name_ar): ?> <?php echo e($categoryDetails->name_ar); ?> <?php endif; ?></title>
...
<style type="text/css">
/*.inner_path{background-image:url(<?php echo e($imageHeaderBg); ?>);*/  background-blend-mode: multiply; background-size:cover; background-position:center center; color:#fff; padding:0 !important;}
...
<?php else: ?>
<style type="text/css">
.inner_path{background-image:url(<?php echo e($imageHeaderBg); ?>); background-color:rgba(0, 0, 0, 0.6); background-blend-mode: multiply; background-size:cover; background-position:center center; color:#fff; padding:40px 0 !important;}
...
<script type="application/ld+json">
    {
      ...
      "@type":"ItemList",
      "itemListElement":[<?php echo trim($jsonprod,','); ?>]
    }
</script>  
<?php endif; ?>      
</head>
...
<div id="tt-pageContent">
	<div class="container-indent">
		<div class="container container-fluid-custom-mobile-padding">
            ...
            <!--end sub category -->
			<div class="row">
				<?php echo $__env->make('website.includes.product_filter_left_panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
				<div class="col-md-12">
					<div class="content-indent">
						<div class="tt-filters-options desctop-no-sidebar">
							<h1 class="tt-title">
								<?php if(app()->getLocale()=="en"): ?> <?php echo e(strtoupper($categoryDetails->name_en)); ?> <?php else: ?> <?php echo e($categoryDetails->name_ar); ?> <?php endif; ?> <span class="tt-title-total">(<?php echo e(count($productLists)); ?>)</span>
							</h1>
							...
							<div class="tt-sort">
								<select name="product_sort_by" id="product_sort_by">
                                    ...
                                    <option value="popular" <?php if(Cookie::get('product_sort_by')=="popular"): ?> selected <?php endif; ?>><?php echo e(__('webMessage.mostpopular')); ?></option>
									<option value="max-price" <?php if(Cookie::get('product_sort_by')=="max-price"): ?> selected <?php endif; ?>><?php echo e(__('webMessage.max_price')); ?></option>
									<option value="min-price" <?php if(Cookie::get('product_sort_by')=="min-price"): ?> selected <?php endif; ?>><?php echo e(__('webMessage.min_price')); ?></option>
									<option value="a-z" <?php if(Cookie::get('product_sort_by')=="a-z"): ?> selected <?php endif; ?>><?php echo e(__('webMessage.atoz')); ?></option>
                                    <option value="z-a" <?php if(Cookie::get('product_sort_by')=="z-a"): ?> selected <?php endif; ?>><?php echo e(__('webMessage.ztoa')); ?></option>
								</select>
								<select name="product_per_page" id="product_per_page">
									<option value="12" <?php if(Cookie::get('product_per_page')=="12"): ?> selected <?php endif; ?>><?php echo e(__('webMessage.show')); ?></option>
									<option value="24" <?php if(Cookie::get('product_per_page')=="24"): ?> selected <?php endif; ?>>24</option>
									<option value="48" <?php if(Cookie::get('product_per_page')=="48"): ?> selected <?php endif; ?>>48</option>
									<option value="96" <?php if(Cookie::get('product_per_page')=="96"): ?> selected <?php endif; ?>>96</option>
								</select>
							</div>
...
fbq('trackCustom', 'ViewCategory', {
  content_name: '<?php echo $catName; ?>',
  content_category: '<?php echo $pixeltree; ?>',
  content_ids:  <?php echo e($pixl); ?>, // top 5-10 results
...
</html><?php /**PATH /home/gulfwebi/tikbazar.gulfweb.ir/resources/views/website/products.blade.php ENDPATH**/ ?>