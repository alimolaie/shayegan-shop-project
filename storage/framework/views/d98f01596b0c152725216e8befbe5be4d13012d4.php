...
<div class="col-md-4 col-lg-3 col-xl-3 leftColumn aside desctop-no-sidebar">
					...
					<div class="tt-collapse open">
						...
						<div class="tt-collapse-content">
							...
							<a href="javascript:;" id="clearallsearch" class="btn-link-02"><?php echo e(strtoupper(__('webMessage.clearall'))); ?></a>
						</div>
					</div>
                    <?php endif; ?>
                    <!--end filter history -->
					...
					<div class="tt-collapse open">
						...
						<div class="tt-collapse-content">
							<ul class="tt-list-row">
								...
								<li><a href="javascript:;" id="<?php echo e($i); ?>-<?php echo e($i+15); ?>" class="search_rangeprice"> <?php echo e($i); ?> <?php echo e(__('webMessage.kd')); ?> — <?php echo e($i+15); ?> <?php echo e(__('webMessage.kd')); ?></a></li>
                                <?php endfor; ?>
							</ul>
						</div>
					</div>
						...
						<div class="tt-collapse-content">
							<ul class="tt-options-swatch options-middle">
                               <?php $__currentLoopData = $prodSizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prodSize): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<li <?php if(!empty(Cookie::get('search_by_size')) && Cookie::get('search_by_size')==$prodSize->id): ?> class="active" <?php endif; ?>><a href="javascript:;" class="search_by_size" id="<?php echo e($prodSize->id); ?>"><?php if(app()->getLocale()=="en" && !empty($prodSize->title_en)): ?> <?php echo e($prodSize->title_en); ?> <?php elseif(app()->getLocale()=="ar" && $prodSize->title_ar): ?> <?php echo e($prodSize->title_ar); ?> <?php endif; ?></a></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							</ul>
						</div>
					</div>
						...
						<div class="tt-collapse-content">
							<ul class="tt-options-swatch options-middle">
                               <?php $__currentLoopData = $prodColors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prodColor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <li <?php if(!empty(Cookie::get('search_by_color')) && Cookie::get('search_by_color')==$prodColor->id): ?> class="active" <?php endif; ?>><a href="javascript:;" class="options-color tt-border search_by_color" id="<?php echo e($prodColor->id); ?>"><img src="<?php echo e(url('uploads/color/thumb/'.$prodColor->image)); ?>"  width="40" height="40"/></a></li>
                                <?php else: ?>
								<li <?php if(!empty(Cookie::get('search_by_color')) && Cookie::get('search_by_color')==$prodColor->id): ?> class="active" <?php endif; ?>><a href="javascript:;" class="options-color tt-border search_by_color" id="<?php echo e($prodColor->id); ?>" style="background-color:<?php echo e($prodColor->color_code); ?>;"></a></li>
                                <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							</ul>
						</div>
                   ...
                   <?php if(!empty($cattags) && count($cattags)>0): ?>
					<div class="tt-collapse open">
						...
						<div class="tt-collapse-content">
							<ul class="tt-list-inline">
								...
								<li><a href="javascript:;" class="search_by_tags" id="<?php echo e($cattag); ?>"><?php echo e($cattag); ?></a></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							</ul>
						</div>
					</div>
                    ...
                    <?php endif; ?>
                    <!--end banner -->
				</div><?php /**PATH /home/kashkha/private/resources/views/website/includes/search_filter_left_panel.blade.php ENDPATH**/ ?>