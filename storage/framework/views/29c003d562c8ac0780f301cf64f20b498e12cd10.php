			...
			<div class="row">
				...
				<div class="col-6">
					<div class="tt-product-single-info">
						...
						<div class="tt-price">
                        <?php if(!empty($productDetails->countdown_datetime) && strtotime($productDetails->countdown_datetime)>strtotime(date('Y-m-d'))): ?>
                        <span class="new-price"><?php echo e(__('webMessage.kd')); ?> <span id=""><?php echo e(round($productDetails->countdown_price,3)); ?></span></span>
                        <span  class="old-price"  id="oldprices"><small><?php echo e(__('webMessage.kd')); ?> <span id=""><?php echo e(round($productDetails->retail_price,3)); ?></span></small></span>
                        ...
                        <?php else: ?>
							<span class="new-price"><?php echo e(__('webMessage.kd')); ?> <span id="display_price"><?php echo e(round($productDetails->retail_price,3)); ?></span></span>
                            <?php if($productDetails->old_price): ?>
							<span class="old-price"  id="oldprices" ><small><?php echo e(__('webMessage.kd')); ?> <span id="display_oldprice"><?php echo e(round($productDetails->old_price,3)); ?></span></small></span>
				...
				<div class="col-2 col-md-4 col-lg-3">
					<div class="tt-product thumbprod-center">
						...
						<div class="tt-description">
							...
							<div class="tt-price">
							<?php if(!empty($relatedProduct->countdown_datetime) && strtotime($relatedProduct->countdown_datetime)>strtotime(date('Y-m-d'))): ?> 	                            <?php echo e(__('webMessage.kd')); ?> <?php echo e($relatedProduct->countdown_price); ?>

                            <?php else: ?>
                            <span class="new-price"> <?php echo e(__('webMessage.kd')); ?> <?php echo e($relatedProduct->retail_price); ?> </span>
						    <?php if(!empty($relatedProduct->old_price)): ?>
							<span class="old-price"> <?php echo e(__('webMessage.kd')); ?> <?php echo e($relatedProduct->old_price); ?> </span>
							<?php endif; ?>
                            <?php endif; ?>
							</div>
							<div class="tt-product-inside-hover">
                                ...
                                <div class="tt-row-btn">
									...
									<?php if(!empty($isStock)): ?>
									<a href="javascript:;"  class="tt-btn-wishlist addtocartsingle" id="<?php echo e($relatedProduct->id); ?>"></a>
								    <?php endif; ?>
								</div>
							</div>
						</div>
...
</html><?php /**PATH /home/kashkha/private/resources/views/website/details.blade.php ENDPATH**/ ?>