...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title><?php echo e(__('adminMessage.websiteName')); ?>|<?php echo e(__('adminMessage.editstate')); ?></title>
			...
			<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
				...
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
					...
					<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
							...
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									...
									<div class="kt-subheader__breadcrumbs">
										...
										<span class="kt-subheader__breadcrumbs-separator"></span>
										<a href="javascript:;" class="kt-subheader__breadcrumbs-link"><?php echo e(__('adminMessage.editstate')); ?></a>
									</div>
								</div>
						...
						<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										...
										<h3 class="kt-portlet__head-title"><?php echo e(__('adminMessage.editstate')); ?></h3>
									</div>
                    ...
                    <form name="tFrm"  id="form_validation"  method="post"
                          class="kt-form" enctype="multipart/form-data" action="<?php echo e(route('state.update',[$editstate->id,$editstate->parent_id])); ?>">
                          <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                       ...
                                       <!--categories name -->         
                                                ...
                                                <input type="text" class="form-control <?php if($errors->has('name_en')): ?> is-invalid <?php endif; ?>" name="name_en"
                                                               value="<?php echo e($editstate->name_en?$editstate->name_en:old('name_en')); ?>" autocomplete="off" placeholder="<?php echo e(__('adminMessage.enter_name_en')); ?>*" />
                                                ...
                                                <input type="text" class="form-control <?php if($errors->has('name_ar')): ?> is-invalid <?php endif; ?>" name="name_ar"
                                                               value="<?php echo e($editstate->name_ar?$editstate->name_ar:old('name_ar')); ?>" autocomplete="off" placeholder="<?php echo e(__('adminMessage.enter_name_ar')); ?>*" />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="form-group row">
													...
													<div class="col-3">
														<span class="kt-switch">
															<label>
																<input type="checkbox" <?php echo e($editstate->is_active==1?'checked':''); ?> name="is_active"  id="is_active" value="1"/>
																<span></span>
															</label>
														</span>
													</div>
													...
													<div class="col-3">
														<input type="text" class="form-control <?php if($errors->has('display_order')): ?> is-invalid <?php endif; ?>" name="display_order"  value="<?php echo e($editstate->display_order?$editstate->display_order:old('display_order')); ?>" autocomplete="off" />
                                                ...
                                                <div class="form-group row">
													...
													<label class="col-3 col-form-label"><?php echo e(__('adminMessage.apply_all_area')); ?></label>
													<div class="col-3">
														<span class="kt-switch">
															<label>
													...
													<div class="col-3">
														<input type="text" class="form-control <?php if($errors->has('delivery_fee')): ?> is-invalid <?php endif; ?>" name="delivery_fee"  value="<?php echo e($editstate->delivery_fee?$editstate->delivery_fee:old('delivery_fee')); ?>" autocomplete="off" />
...
['fontname', ['fontname']],
	...
	<!-- end::Body -->
</html><?php /**PATH /home/kashkha/private/resources/views/gwc/state/edit.blade.php ENDPATH**/ ?>