...
<body>
<?php if($orderDetails->device_type!="mobile"): ?>
<!--preloader -->
...
<div class="tt-breadcrumb">
	<div class="container">
		<ul>
            ...
            <li><?php if(!empty($orderDetails->order_id)): ?> <?php echo e($orderDetails->order_id); ?><?php else: ?> -- <?php endif; ?></li>
		</ul>
	</div>
</div>
<?php endif; ?>
            ...
            <?php endif; ?>
			          ...
			          <!-- order status details -->
						...
						<div class="row" style="border:1px #CCCCCC solid;margin-top:20px;padding:20px;border-radius:5px;">
                                    ...
                                    <label for="orderid"><?php echo e(__('webMessage.orderid')); ?> : <?php if($orderDetails->order_id): ?> <?php echo e($orderDetails->order_id); ?><?php else: ?> -- <?php endif; ?></label>
									</div>
                                    </div>
                                    <div class="col-xs-12 col-md-3 col-lg-2">
                                    <div class="form-group">
                                    <label for="paymentmethod"><?php echo e(__('webMessage.paymentmethod')); ?> : <?php if($orderDetails->pay_mode): ?> <?php echo e(__($orderDetails->pay_mode)); ?><?php else: ?> -- <?php endif; ?></label>
                                    </div>
                                    </div>
                                    <div class="col-xs-12 col-md-3 col-lg-2">
                                    <div class="form-group">
                                    <label for="is_paid"><?php echo e(__('webMessage.payment_status')); ?> : <?php if($orderDetails->is_paid): ?> <font color="#009900"><?php echo e(strtoupper(__('webMessage.paid'))); ?></font><?php else: ?> <font color="#FF0000"><?php echo e(strtoupper(__('webMessage.notpaid'))); ?></font> <?php endif; ?></label>
                                    </div>
                                    </div>
									 <?php 
...
<!--footer-->
<?php if(!empty($orderDetails->device_type) && $orderDetails->device_type!="mobile"): ?>
...
<?php if(!empty($orderDetails->pay_mode) && $orderDetails->pay_mode=='POSTKNET'): ?>
<script>
$(document).ready(function(){
$("#spancartbox").html("<h3 class='alert alert-default'><?php echo e(trans('webMessage.thankyoufordoingbusinesswithus')); ?></h3>");
$("#modalDefaultBox").modal("show");//show modal
});	 
</script>	
<?php endif; ?> 
</body>
</html><?php /**PATH /home/kashkha/private/resources/views/website/ordercompleted.blade.php ENDPATH**/ ?>