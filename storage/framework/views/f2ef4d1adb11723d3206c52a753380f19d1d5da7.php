...
<html lang="en">
	...
	<head>
		...
		<meta charset="utf-8" />
		<title><?php echo e(__('adminMessage.websiteName')); ?>|<?php echo e(__('adminMessage.devicetoken')); ?></title>
						...
						<div class="kt-subheader   kt-grid__item" id="kt_subheader">
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									<h3 class="kt-subheader__title"><?php echo e(__('adminMessage.devicetoken')); ?></h3>
									...
									<div class="kt-subheader__breadcrumbs">
										...
										<a href="javascript:;" class="kt-subheader__breadcrumbs-link"><?php echo e(__('adminMessage.devicetoken')); ?></a>
							...
							<div class="kt-portlet kt-portlet--mobile">
								<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										...
										<h3 class="kt-portlet__head-title">
											<?php echo e(__('adminMessage.devicetoken')); ?>
                                ...
                                <?php if(auth()->guard('admin')->user()->can('webpush-list')): ?>
									...
									<table class="table table-striped- table-bordered table-hover table-checkable " id="kt_table_1">
                                        ...
                                        <?php $p=1; ?>
                                        <?php $__currentLoopData = $webPushLists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$webPushList): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<tr class="search-body">
												<td><?php echo e($webPushLists->firstItem() + $key); ?></td>
												<td><div style="overflow:scroll;width:800px;"><?php echo $webPushList->device_token; ?></div></td>
												<td><?php echo $webPushList->created_at; ?></td>
												<td><?php echo $webPushList->updated_at; ?></td>
													...
													<div class="modal-dialog" role="document">
														<div class="modal-content">
															...
															<div class="modal-footer">
																...
																<button type="button" class="btn btn-danger"  onClick="Javascript:window.location.href='<?php echo e(url('gwc/webpush/devicetokens/delete/'.$webPushList->id)); ?>'"><?php echo e(__('adminMessage.yes')); ?></button>
															</div>
														</div>
													</div>
												</div>
                                        ...
                                        <tr><td colspan="4" class="text-center"><?php echo e($webPushLists->links()); ?></td></tr> 
                                        <?php else: ?>
                                        <tr><td colspan="4" class="text-center"><?php echo e(__('adminMessage.recordnotfound')); ?></td></tr>
                                        <?php endif; ?>    
										</tbody>
									</table>
                                <?php else: ?>
	...
	<!-- end::Body -->
</html><?php /**PATH /home/kashkha/private/resources/views/gwc/webpush/webtokens.blade.php ENDPATH**/ ?>