...
<head>
<meta charset="utf-8">
<title><?php if(app()->getLocale()=="en"): ?> <?php echo e($settingInfo->name_en); ?> <?php else: ?> <?php echo e($settingInfo->name_ar); ?> <?php endif; ?> | <?php echo e(__('webMessage.offers')); ?></title>
...
<div class="tt-breadcrumb">
	<div class="container">
		<ul>
			...
			<li><a href="javascript:;"><?php echo e(__('webMessage.offers')); ?></a></li>
		</ul>
	</div>
</div>
				...
				<div class="col-md-12">
					<div class="content-indent">
						<div class="tt-filters-options desctop-no-sidebar">
							<h1 class="tt-title">
								<?php echo e(__('webMessage.offers')); ?> <span class="tt-title-total">(<?php echo e(count($offerProductLists)); ?>)</span>
							</h1>
							...
							<div class="tt-sort">
					<select name="offer_sort_by" id="offer_sort_by">
                    <option value=""><?php echo e(__('webMessage.latestitems')); ?></option>
                    <option value="popular" <?php if(Cookie::get('offer_sort_by')=="popular"): ?> selected <?php endif; ?>><?php echo e(__('webMessage.mostpopular')); ?></option>
					<option value="max-price" <?php if(Cookie::get('offer_sort_by')=="max-price"): ?> selected <?php endif; ?>><?php echo e(__('webMessage.max_price')); ?></option>
					<option value="min-price" <?php if(Cookie::get('offer_sort_by')=="min-price"): ?> selected <?php endif; ?>><?php echo e(__('webMessage.min_price')); ?></option>
					<option value="a-z" <?php if(Cookie::get('offer_sort_by')=="a-z"): ?> selected <?php endif; ?>><?php echo e(__('webMessage.atoz')); ?></option>
                    <option value="z-a" <?php if(Cookie::get('offer_sort_by')=="z-a"): ?> selected <?php endif; ?>><?php echo e(__('webMessage.ztoa')); ?></option>
					</select>
					<select name="offer_per_page" id="offer_per_page">
					<option value="12" <?php if(Cookie::get('offer_per_page')=="12"): ?> selected <?php endif; ?>><?php echo e(__('webMessage.show')); ?></option>
					<option value="24" <?php if(Cookie::get('offer_per_page')=="24"): ?> selected <?php endif; ?>>24</option>
					<option value="48" <?php if(Cookie::get('offer_per_page')=="48"): ?> selected <?php endif; ?>>48</option>
					<option value="96" <?php if(Cookie::get('offer_per_page')=="96"): ?> selected <?php endif; ?>>96</option>
					</select>
							</div>
                        ...
                        <?php if(!empty($offerProductLists) && count($offerProductLists)>0): ?>
						<div class="tt-product-listing row">
                         <?php $tagsDetails=''; ?>
                        <?php $__currentLoopData = $offerProductLists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productList): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<?php
						...
						<div class="text-center tt_product_showmore">
                           <?php echo $offerProductLists->links(); ?>
...
</html><?php /**PATH /home/kashkha/private/resources/views/website/offers.blade.php ENDPATH**/ ?>