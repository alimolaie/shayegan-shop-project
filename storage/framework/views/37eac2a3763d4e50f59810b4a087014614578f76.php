...
<html lang="en">
	...
	<head>
		...
		<meta charset="utf-8" />
		<title><?php echo e(__('adminMessage.websiteName')); ?>|<?php echo e(__('adminMessage.singlepages')); ?></title>
							...
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									...
									<div class="kt-subheader__breadcrumbs">
										...
										<a href="javascript:;" class="kt-subheader__breadcrumbs-link"><?php echo e(__('adminMessage.singlepageslisting')); ?></a>
								...
								<div class="kt-subheader__toolbar">
									...
									<div class="btn-group">
                                        <?php if(auth()->guard('admin')->user()->can('singlepages-create')): ?>
										<a href="<?php echo e(url('gwc/singlepages/create')); ?>" class="btn btn-brand btn-bold"><i class="la la-plus"></i>&nbsp;<?php echo e(__('adminMessage.createnew')); ?></a>
                                        <?php endif; ?>
										...
										<div class="dropdown-menu dropdown-menu-right">
											<ul class="kt-nav">
                                                ...
                                                <li class="kt-nav__item">
													<a href="<?php echo e(url('gwc/singlepages/pdf')); ?>" class="kt-nav__link">
														<i class="kt-nav__link-icon flaticon-file-2"></i>
														<span class="kt-nav__link-text"><?php echo e(__('adminMessage.downloadpdf')); ?></span>
													</a>
												</li>
							...
							<div class="kt-portlet kt-portlet--mobile">
								<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										...
										<h3 class="kt-portlet__head-title">
											<?php echo e(__('adminMessage.singlepageslisting')); ?>
                                ...
                                <?php if(auth()->guard('admin')->user()->can('singlepages-list')): ?>
									...
									<table class="table table-striped- table-bordered table-hover table-checkable " id="kt_table_1">
										...
										<tbody>
                                        <?php if(count($singlepagesLists)): ?>
                                        <?php $p=1; ?>
                                        <?php $__currentLoopData = $singlepagesLists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$singlepagesList): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<tr class="search-body">
												<td><?php echo e($singlepagesLists->firstItem() + $key); ?></td>
												<td><?php echo $singlepagesList->title_en; ?></td>
												<td><?php echo $singlepagesList->title_ar; ?></td>
												<td>
                                                <?php if($singlepagesList->image): ?>
                                                <img src="<?php echo url('uploads/singlepages/thumb/'.$singlepagesList->image); ?>" width="40">
                                                <?php endif; ?></td>
												<td>
                                                <span class="kt-switch"><label><input value="<?php echo e($singlepagesList->id); ?>" <?php echo e(!empty($singlepagesList->is_active)?'checked':''); ?> type="checkbox"  id="singlepages" class="change_status"><span></span></label></span>
                                                </td>
												<td><?php echo $singlepagesList->created_at; ?></td>
												<td><?php echo $singlepagesList->updated_at; ?></td>
                                                <td class="kt-datatable__cell">
                                                 ...
                                                 <li class="kt-nav__item"><a href="<?php echo e(url('gwc/singlepages/'.$singlepagesList->id.'/edit')); ?>" class="kt-nav__link"><i class="kt-nav__link-icon flaticon2-contract"></i><span class="kt-nav__link-text"><?php echo e(__('adminMessage.edit')); ?></span></a></li>
                                                 <?php endif; ?>
                                                 <?php if(auth()->guard('admin')->user()->can('singlepages-delete')): ?>
                                                 <li class="kt-nav__item"><a href="javascript:;" data-toggle="modal" data-target="#kt_modal_<?php echo e($singlepagesList->id); ?>" class="kt-nav__link"><i class="kt-nav__link-icon flaticon2-trash"></i><span class="kt-nav__link-text"><?php echo e(__('adminMessage.delete')); ?></span></a></li>
                                                 <?php endif; ?>
                                                 </ul>
                                                 </div>
                                                 </div>
                                                 ...
                                                 <!--Delete modal -->
 <div class="modal fade" id="kt_modal_<?php echo e($singlepagesList->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-footer">
											...
											<button type="button" class="btn btn-danger"  onClick="Javascript:window.location.href='<?php echo e(url('gwc/singlepages/delete/'.$singlepagesList->id)); ?>'"><?php echo e(__('adminMessage.yes')); ?></button>
										</div>
									</div>
								</div>
							</div>
                                        ...
                                        <tr><td colspan="8" class="text-center"><?php echo e($singlepagesLists->links()); ?></td></tr> 
                                        <?php else: ?>
	...
	<!-- end::Body -->
</html><?php /**PATH /home/gulfwebi/tikbazar.gulfweb.ir/resources/views/gwc/singlepages/index.blade.php ENDPATH**/ ?>