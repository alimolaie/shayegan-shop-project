...
<html lang="en">
	...
	<head>
		...
		<meta charset="utf-8" />
		<title><?php echo e(__('adminMessage.websiteName')); ?> | <?php echo e(__('adminMessage.emailsubscribers')); ?></title>
						...
						<div class="kt-subheader   kt-grid__item" id="kt_subheader">
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									<h3 class="kt-subheader__title"><?php echo e(__('adminMessage.emailsubscribers')); ?></h3>
								</div>
                                <div class="kt-subheader__toolbar">
									<div class="btn-group">
                                      <form class="kt-margin-l-20" method="post" id="kt_subheader_search_form" action="<?php echo e(route('searchSubscribers')); ?>">
                                        ...
                                        <?php if(auth()->guard('admin')->user()->can('email-subscribers-list')): ?>
										<a href="<?php echo e(url('gwc/subscribers/csv')); ?>" class="btn btn-brand btn-bold"><i class="la la-plus"></i>&nbsp;<?php echo e(__('adminMessage.exportascsv')); ?></a>
                                        <?php endif; ?>
							...
							<div class="kt-portlet kt-portlet--mobile">
								<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										...
										<h3 class="kt-portlet__head-title">
											<?php echo e(__('adminMessage.emailsubscribers')); ?>
                                ...
                                <?php if(auth()->guard('admin')->user()->can('email-subscribers-list')): ?>
									...
									<table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
										...
										<tbody>
                                        <?php if(count($subscriberLists)): ?>
                                        <?php $p=1; ?>
                                        <?php $__currentLoopData = $subscriberLists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$subscriberList): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        
											<tr>
												<td><?php echo e($subscriberLists->firstItem() + $key); ?></td>
												<td><?php echo $subscriberList->newsletter_email; ?></td>
												<td><?php echo e(\Carbon\Carbon::parse($subscriberList->created_at)->diffForHumans()); ?></td>
                                                <td class="kt-datatable__cell">
                                                 <?php if(auth()->guard('admin')->user()->can('logs-delete')): ?>
                                                 <a  title="<?php echo e(__('adminMessage.delete')); ?>" href="javascript:;" data-toggle="modal" data-target="#kt_modal_<?php echo e($subscriberList->id); ?>" class="kt-nav__link"><i class="kt-nav__link-icon flaticon2-trash"></i></a>
                                                 <?php endif; ?>
                                                 
                                                 <!--Delete modal -->
                        <div class="modal fade" id="kt_modal_<?php echo e($subscriberList->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-footer">
											...
											<button type="button" class="btn btn-danger"  onClick="Javascript:window.location.href='<?php echo e(url('gwc/subscribers/delete/'.$subscriberList->id)); ?>'"><?php echo e(__('adminMessage.yes')); ?></button>
										</div>
									</div>
								</div>
							</div>
                                        ...
                                        <tr><td colspan="9" class="text-center"><?php echo e($subscriberLists->links()); ?></td></tr>
	...
	<!-- end::Body -->
</html><?php /**PATH /home/gulfwebi/tikbazar.gulfweb.ir/resources/views/gwc/user/adminSubscriber.blade.php ENDPATH**/ ?>