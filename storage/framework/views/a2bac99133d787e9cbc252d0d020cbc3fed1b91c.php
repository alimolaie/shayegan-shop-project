...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title><?php echo e(__('adminMessage.websiteName')); ?>|<?php echo e(__('adminMessage.createoptions')); ?></title>
				...
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
					...
					<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
							...
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									...
									<div class="kt-subheader__breadcrumbs">
										...
										<a href="javascript:;" class="kt-subheader__breadcrumbs-link"><?php echo e(__('adminMessage.createoptions')); ?></a>
									</div>
								</div>
						...
						<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										...
										<h3 class="kt-portlet__head-title"><?php echo e(__('adminMessage.createoptions')); ?></h3>
									</div>
					...
					<?php if(auth()->guard('admin')->user()->can('options-create')): ?>
                         ...
                         <form name="tFrm"  id="form_validation"  method="post"
                          class="kt-form" enctype="multipart/form-data" action="<?php echo e(route('options.store')); ?>">
                          <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
											<div class="kt-portlet__body">
                                                ...
                                                <input type="text" class="form-control <?php if($errors->has('option_name_en')): ?> is-invalid <?php endif; ?>" name="option_name_en"
                                                               value="<?php echo e(old('option_name_en')); ?>" autocomplete="off" placeholder="<?php echo e(__('adminMessage.enter_option_name')); ?>" />
                                                ...
                                                <input type="text" class="form-control <?php if($errors->has('option_name_ar')): ?> is-invalid <?php endif; ?>" name="option_name_ar"
                                                               value="<?php echo e(old('option_name')); ?>" autocomplete="off" placeholder="<?php echo e(__('adminMessage.enter_option_name')); ?>*" />
                                                ...
                                                <option value="<?php echo e($optionsSubList); ?>"><?php echo e($optionsSubList); ?></option>
                                            ...
                                            <div id="kt_repeater_1" class="kt_repeater_1">
												<div class="form-group form-group-last row" id="kt_repeater_1">
													<div data-repeater-list="attach" class="col-lg-12">
														<div data-repeater-item class="form-group row align-items-center repeatbox <?php if($errors->has('attach')): ?> is-invalid <?php endif; ?>">
															<div class="col-lg-4">
	...
	<!-- end::Body -->
</html><?php /**PATH /home/kashkha/private/resources/views/gwc/options/create.blade.php ENDPATH**/ ?>