...
<head>
<meta charset="utf-8">
<title><?php if(app()->getLocale()=="en"): ?> <?php echo e($settingInfo->name_en); ?> <?php else: ?> <?php echo e($settingInfo->name_ar); ?> <?php endif; ?> | <?php if(app()->getLocale()=="en"): ?> <?php echo e($sectionDetails->title_en); ?> <?php else: ?> <?php echo e($sectionDetails->title_ar); ?> <?php endif; ?></title>
...
<div class="tt-breadcrumb">
	<div class="container">
		<ul>
			...
			<li><?php if(app()->getLocale()=="en"): ?> <?php echo e($sectionDetails->title_en); ?> <?php else: ?> <?php echo e($sectionDetails->title_ar); ?> <?php endif; ?></li>
		</ul>
	</div>
</div>
				...
				<div class="col-md-12">
					<div class="content-indent">
						<div class="tt-filters-options desctop-no-sidebar">
							<h1 class="tt-title">
								<?php if(app()->getLocale()=="en"): ?> <?php echo e(strtoupper($sectionDetails->title_en)); ?> <?php else: ?> <?php echo e($sectionDetails->title_ar); ?> <?php endif; ?> <span class="tt-title-total">(<?php echo e(count($productLists)); ?>)</span>
							</h1>
                        ...
                        <span id="responseMsg-<?php echo e($productList->id); ?>"></span> 
							...
							<div class="tt-product-inside-hover">
								...
								<div class="tt-row-btn">
									...
									<a href="javascript:;" class="tt-btn-addtocart thumbprod-button-bg addtocartsingle" id="<?php echo e($productList->id); ?>"><?php echo e(__('webMessage.preorder')); ?></a>
                                    <?php else: ?>
                                    <a href="javascript:;" class="tt-btn-addtocart thumbprod-button-bg addtocartsingle" id="<?php echo e($productList->id); ?>"><?php echo e(__('webMessage.addtocart_btn')); ?></a>
                                    <?php endif; ?>
                                    <?php endif; ?>
									<?php endif; ?>
								</div>
...
</html><?php /**PATH /home/gulfwebi/tikbazar.gulfweb.ir/resources/views/website/sections.blade.php ENDPATH**/ ?>