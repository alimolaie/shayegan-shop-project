...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title><?php echo e(__('adminMessage.websiteName')); ?>|<?php echo e(__('adminMessage.editslideshow')); ?></title>
			...
			<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
				...
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
					...
					<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
							...
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									...
									<div class="kt-subheader__breadcrumbs">
										...
										<a href="javascript:;" class="kt-subheader__breadcrumbs-link"><?php echo e(__('adminMessage.editslideshow')); ?></a>
									</div>
								</div>
						...
						<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										...
										<h3 class="kt-portlet__head-title"><?php echo e(__('adminMessage.editslideshow')); ?></h3>
									</div>
                    ...
                    <form name="tFrm"  id="form_validation"  method="post"
                          class="kt-form" enctype="multipart/form-data" action="<?php echo e(route('slideshow.update',$editslideshow->id)); ?>">
                          <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                       ...
                                       <!--categories name -->         
                                                ...
                                                <textarea name="title_en" class="form-control <?php if($errors->has('title_en')): ?> is-invalid <?php endif; ?>" autocomplete="off" placeholder="<?php echo e(__('adminMessage.enter_title_en')); ?>"><?php echo $editslideshow->title_en?$editslideshow->title_en:old('title_en'); ?></textarea>
                                                ...
                                                <textarea name="title_ar" class="form-control <?php if($errors->has('title_ar')): ?> is-invalid <?php endif; ?>" autocomplete="off" placeholder="<?php echo e(__('adminMessage.enter_title_ar')); ?>"><?php echo $editslideshow->title_ar?$editslideshow->title_ar:old('title_ar'); ?></textarea>
                                                ...
                                                <input type="text" class="form-control <?php if($errors->has('link')): ?> is-invalid <?php endif; ?>" name="link"
                                                               value="<?php echo $editslideshow->link?$editslideshow->link:old('link'); ?>" autocomplete="off" placeholder="<?php echo e(__('adminMessage.enter_link')); ?>" />
											...
											<option value="web" <?php if($editslideshow->link_type=="web"): ?> selected <?php endif; ?> >Web</option>
											<option value="category" <?php if($editslideshow->link_type=="category"): ?> selected <?php endif; ?> >Category</option>
											<option value="product" <?php if($editslideshow->link_type=="product"): ?> selected <?php endif; ?> >Product</option>
											</select>
                                            ...
                                            <input type="text" class="form-control <?php if($errors->has('link_id')): ?> is-invalid <?php endif; ?>" name="link_id"
                                                               value="<?php echo $editslideshow->link_id?$editslideshow->link_id:old('link_id'); ?>" autocomplete="off" placeholder="<?php echo e(__('adminMessage.enter_link')); ?>" />
                                         ...
                                         <div class="form-group row">
                                                ...
                                                <div class="col-lg-2">
                                                <?php if($editslideshow->image): ?>
                                                <br>
                                                <img src="<?php echo url('uploads/slideshow/thumb/'.$editslideshow->image); ?>" width="40">
                                                <?php endif; ?>
                                                </div>
                                                <div class="col-lg-6">
                                                <div class="form-group row">
													...
													<div class="col-3">
														<span class="kt-switch">
															<label>
																<input type="checkbox" <?php echo e($editslideshow->is_active==1?'checked':''); ?> name="is_active"  id="is_active" value="1"/>
																<span></span>
															</label>
														</span>
													</div>
													...
													<div class="col-3">
														<input type="text" class="form-control <?php if($errors->has('display_order')): ?> is-invalid <?php endif; ?>" name="display_order"  value="<?php echo e($editslideshow->display_order?$editslideshow->display_order:old('display_order')); ?>" autocomplete="off" />
...
['fontname', ['fontname']],
	...
	<!-- end::Body -->
</html><?php /**PATH /home/gulfwebi/tikbazar.gulfweb.ir/resources/views/gwc/slideshow/edit.blade.php ENDPATH**/ ?>