            ...
            <ul class="product-nav list-style-none">
                <li class="product-nav-prev">
                    ...
                    <span class="product-nav-popup">
                            <img src="<?php echo e(asset('website_assets/assets/images/products/product-nav-next.jpg')); ?>" alt="Product" width="110"
                                 height="110" />
                        ...
                        <div class="product product-single row">
                                ...
                                <div class="product-gallery product-gallery-sticky">
                                    <div class="swiper-container product-single-swiper swiper-theme nav-inner" data-swiper-options="{
                                        ...
                                        <div class="swiper-wrapper row cols-1 gutter-no">
                                            <?php if(\Illuminate\Support\Facades\DB::table('gwc_products_gallery')->where('product_id',$product->id)->exists()): ?>
                                            ...
                                            <div class="swiper-slide">
                                                <figure class="product-image">
                                                    <img src="<?php echo e(asset('uploads/product/thumb/'.$gallary->image)); ?>"
                                                         data-zoom-image="<?php echo e(asset('uploads/product/thumb/'.$gallary->image)); ?>"
                                            ...
                                            <?php else: ?>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="<?php echo e(asset('uploads/product/original/'.$product->image)); ?>"
                                                             data-zoom-image="<?php echo e(asset('uploads/product/original/'.$product->image)); ?>"
                                                             alt="ساعت مچی مشکی الکترونیکی" width="800" height="900">
                                                    </figure>
                                                </div>
                                       <?php endif; ?>
                            ...
                            <div class="col-md-6 mb-4 mb-md-6">
                                <div class="product-details" data-sticky-options="{'minWidth': 767}">
                                    <h1 class="product-title"><?php echo e($product->title_ar); ?></h1>
                                    <div class="product-bm-wrapper">
                                        <div class="product-meta">
                                            ...
                                            <div class="product-sku">
                                                کد:  <span><?php echo e($product->sku_no); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="product-price"><ins class="new-price"><?php echo e(number_format($product->retail_price)); ?> تومان </ins></div>
                                    ...
                                    <div class="product-short-desc">
                                        <ul class="list-type-check list-style-none">
                                            ...
                                            <?php echo e($product->sdetails_ar); ?>
                                    ...
                                    <form action="<?php echo e(url('users/add-to-cart/'.$product->id)); ?>" method="post">
                                        <?php echo csrf_field(); ?>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6 mb-4">
                                            <figure class="vendor-banner br-sm">
                                                <img src="<?php echo e(asset('website_assets/assets/images/products/vendor-banner.jpg')); ?>"
                                        ...
                                        <div class="col-md-6 pl-2 pl-md-6 mb-4">
                                            <div class="vendor-user">
                                                <figure class="vendor-logo mr-4">
                                                    <a href="#">
                                                        <img src="<?php echo e(asset('website_assets/assets/images/products/vendor-logo.jpg')); ?>"
                                            ...
                                            <div class="tab-pane active" id="show-all">
                                                <ul class="comments list-style-none">
                                                    <li class="comment">
                                                        <div class="comment-body">
                                                            <figure class="comment-avatar">
                                                                <img src="<?php echo e(asset('website_assets/assets/images/agents/1-100x100.png')); ?>"
                                                            ...
                                                            <div class="comment-content">
                                                                ...
                                                                <div class="comment-action">
                                                                    ...
                                                                    <div class="review-image">
                                                                        <a href="#">
                                                                            <figure>
                                                                                <img src="<?php echo e(asset('website_assets/assets/images/products/default/review-img-1.jpg')); ?>"
                                                                                     width="60" height="60"
                                                                                     alt="تصویر ضمیمه نقد جان دو در ساعت مچی مشکی الکترونیکی"
                                                                                     data-zoom-image="<?php echo e(asset('website_assets/assets/images/products/default/review-img-1-800x900.jpg')); ?>" />
                                                                            </figure>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <li class="comment">
                                                        <div class="comment-body">
                                                            <figure class="comment-avatar">
                                                                <img src="<?php echo e(asset('website_assets/assets/images/agents/2-100x100.png')); ?>"
                                                                     alt="Commenter Avatar" width="90" height="90">
                                                            </figure>
                                                            <div class="comment-content">
                                                                <h4 class="comment-author">
                                                                ...
                                                                <div class="comment-action">
                                                                    ...
                                                                    <div class="review-image">
                                                                        <a href="#">
                                                                            <figure>
                                                                                <img src="<?php echo e(asset('website_assets/assets/images/products/default/review-img-2.jpg')); ?>"
                                                                                     width="60" height="60"
                                                                                     alt="تصویر ضمیمه نقد جان دو در ساعت مچی مشکی الکترونیکی"
                                                                                     data-zoom-image="<?php echo e(asset('website_assets/assets/images/products/default/review-img-2.jpg')); ?>" />
                                                                            </figure>
                                                                        </a>
                                                                        <a href="#">
                                                                            <figure>
                                                                                <img src="<?php echo e(asset('website_assets/assets/images/products/default/review-img-3.jpg')); ?>"
                                                                                     width="60" height="60"
                                                                                     alt="تصویر ضمیمه نقد جان دو در ساعت مچی مشکی الکترونیکی"
                                                                                     data-zoom-image="<?php echo e(asset('website_assets/assets/images/products/default/review-img-3.jpg')); ?>" />
                                                                            </figure>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <li class="comment">
                                                        <div class="comment-body">
                                                            <figure class="comment-avatar">
                                                                <img src="<?php echo e(asset('website_assets/assets/images/agents/3-100x100.png')); ?>"
                                                                     alt="Commenter Avatar" width="90" height="90">
                                                            </figure>
                                                            <div class="comment-content">
                                                                <h4 class="comment-author">
                                                                        ...
                                                                        <a href="#">
                                                                            <figure>
                                                                                <img src="<?php echo e(asset('website_assets/assets/images/products/default/review-img-1.jpg')); ?>"
                                                                                     width="60" height="60"
                                                                                     alt="تصویر ضمیمه نقد جان دو در ساعت مچی مشکی الکترونیکی"
                                                                                     data-zoom-image="<?php echo e(asset('website_assets/assets/images/products/default/review-img-1.jpg')); ?>" />
                                                                            </figure>
                                                                        </a>
                                                                    </div>
                                                                </div>
                        ...
                        <section class="related-product-section">
                            ...
                            <div class="swiper-container swiper-theme" data-swiper-options="{
                                ...
                                <div class="swiper-wrapper row cols-lg-3 cols-md-4 cols-sm-3 cols-2">
                                    <?php $__currentLoopData = $lastProduct; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $last): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="swiper-slide product">
                                            <figure class="product-media">
                                                <a href="<?php echo e(url('product/'.$last->id)); ?>">
                                                    <img src="<?php echo e(asset('uploads/product/original/'.$last->image)); ?>" alt="Product"
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name"><a href="<?php echo e(url('product/'.$last->id)); ?>"><?php echo e($last->title_ar); ?> </a></h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                                        <span class="ratings" style="width: 100%;"></span>
                                                        <span class="tooltiptext tooltip-top"></span>
                                                    </div>
                                                    <a href="<?php echo e(url('product/'.$last->id)); ?>" class="rating-reviews">(3 نظر )</a>
                                                </div>
                                                <div class="product-pa-wrapper">
                                                    <div class="product-price">
                                                        <ins class="new-price"><?php echo e(number_format($last->retail_price)); ?> تومان</ins>
                                                        <?php if($last->old_price!=null): ?>
                                                            <del class="old-price"><?php echo e(number_format($last->old_price)); ?> تومان</del>
                                                        <?php endif; ?>
                                        ...
                                        <div class="swiper-container swiper-theme nav-top" data-swiper-options = "{
                                            ...
                                            <div class="swiper-wrapper">
                                                <div class="widget-col swiper-slide">
                                                    <?php $__currentLoopData = $radonProduct1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $random1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="product product-widget">
                                                            <figure class="product-media">
                                                                <a href="<?php echo e(url('product/'.$random1->id)); ?>">
                                                                    <img src="<?php echo e(asset('uploads/product/original/'.$random1->image)); ?>" alt="Product"
                                                                         width="100" height="113" />
                                                                </a>
                                                            </figure>
                                                            <div class="product-details">
                                                                <h4 class="product-name">
                                                                    <a href="#"><?php echo e($random1->title_ar); ?> </a>
                                                                </h4>
                                                                <div class="ratings-container">
                                                                    <div class="ratings-full">
                                                                        <span class="ratings" style="width: 100%;"></span>
                                                                ...
                                                                <div class="product-price">
                                                                    <ins class="new-price"><?php echo e(number_format($random1->retail_price)); ?> تومان</ins>
                                                                    <?php if($random1->old_price!=null): ?>
                                                                        <del class="old-price"><?php echo e(number_format($random1->old_price)); ?> تومان</del>
                                                                    <?php endif; ?>
                                                ...
                                                <div class="widget-col swiper-slide">
                                                    <?php $__currentLoopData = $radonProduct2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $random2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="product product-widget">
                                                            <figure class="product-media">
                                                                <a href="<?php echo e(url('product/'.$random2->id)); ?>">
                                                                    <img src="<?php echo e(asset('uploads/product/original/'.$random2->image)); ?>" alt="Product"
                                                                         width="100" height="113" />
                                                                </a>
                                                            </figure>
                                                            <div class="product-details">
                                                                <h4 class="product-name">
                                                                    <a href="#"><?php echo e($random2->title_ar); ?> </a>
                                                                </h4>
                                                                <div class="ratings-container">
                                                                    <div class="ratings-full">
                                                                        <span class="ratings" style="width: 100%;"></span>
                                                                ...
                                                                <div class="product-price">
                                                                    <ins class="new-price"><?php echo e(number_format($random2->retail_price)); ?> تومان</ins>
                                                                    <?php if($random2->old_price!=null): ?>
                                                                        <del class="old-price"><?php echo e(number_format($random2->old_price)); ?> تومان</del>
                                                                    <?php endif; ?>
...
<?php echo $__env->make('front.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\shayegan_project\shop\resources\views/front/website/product-details.blade.php ENDPATH**/ ?>